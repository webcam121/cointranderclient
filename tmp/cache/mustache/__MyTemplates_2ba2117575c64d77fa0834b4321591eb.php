...
class __MyTemplates_2ba2117575c64d77fa0834b4321591eb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEf43568e4a5bd248825a261e3640379f($context, $indent, $value);
...
';
    ...
    private function sectionE03439246cffa97f7e9cd3753a073b6d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionEf43568e4a5bd248825a261e3640379f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionE03439246cffa97f7e9cd3753a073b6d($context, $indent, $value);
                $context->pop();
            }
        }
