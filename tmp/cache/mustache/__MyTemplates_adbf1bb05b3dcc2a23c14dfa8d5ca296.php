...
class __MyTemplates_adbf1bb05b3dcc2a23c14dfa8d5ca296 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3ecbf50828dc18d1fcce3fc6a67c3481($context, $indent, $value);
...
';
    ...
    private function section3ecbf50828dc18d1fcce3fc6a67c3481(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                    <div class="nk-ecwg nk-ecwg12">
';
                $buffer .= $indent . '                                    <div class="data">
';
                $buffer .= $indent . '                                            <div class="data-group">
