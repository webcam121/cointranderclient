...
class __MyTemplates_d4040d0aed3ca44a09de2cb1e2bf7b02 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5812dda390241125f08bb492b085db93($context, $indent, $value);
...
';
    ...
    private function section5812dda390241125f08bb492b085db93(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                            <div class="form-control-wrap">
';
                $buffer .= $indent . '                                            <span class="title">sdfsfs</span>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
