...
class __MyTemplates_a195c729cd159905158d2fb3b6a78db8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2406d3cabc8e36d927542e002a1584fd($context, $indent, $value);
...
';
    ...
    private function section2406d3cabc8e36d927542e002a1584fd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                      ...
                      <div style="column-count: 5;column-gap: 40px;">
                        <div class="">
                            <div class="card">
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="column-count: 5;column-gap: 40px;">
';
