...
class __MyTemplates_7d3905b73f12dc74a09b17b6d70107e8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4c43030f60be6138c069bedd426be4ba($context, $indent, $value);
...
';
    ...
    private function section4c43030f60be6138c069bedd426be4ba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
