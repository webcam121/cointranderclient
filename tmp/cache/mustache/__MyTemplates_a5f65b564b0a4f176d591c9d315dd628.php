...
class __MyTemplates_a5f65b564b0a4f176d591c9d315dd628 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section330b083787c38f3fae35edd096455042($context, $indent, $value);
...
';
    ...
    private function section330b083787c38f3fae35edd096455042(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
