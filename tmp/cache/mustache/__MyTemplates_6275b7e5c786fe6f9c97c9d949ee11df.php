...
class __MyTemplates_6275b7e5c786fe6f9c97c9d949ee11df extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section68d252b08f8daccd8c40c35989271fd8($context, $indent, $value);
...
';
    ...
    private function section65d60c8a6d04c427ac7332b8fb0315a8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col">
                                            <div class="d-none d-md-inline">
                                                <a href="/clinetAccountDetailsOfAgent?userId={{id}}" class="link link-sm"><span>ClientView</span></a>
                                            </div>
                                        </div>
                                    </div><!-- .nk-tb-item -->
...
';
                ...
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" class="link link-sm"><span>ClientView</span></a>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
...
';
    ...
    private function section54fd20bc854b6251b399ae1792026163(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section68d252b08f8daccd8c40c35989271fd8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                        ...
                        <div class="nk-block-between-md g-4">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des">
                                    <p>You can see client account as you want.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
';
                $buffer .= $indent . '                                    <p>You can see client account as you want.</p>
';
                $buffer .= $indent . '                                </div>
';
                $buffer .= $indent . '                            </div>
...
';
                ...
                $buffer .= $this->section65d60c8a6d04c427ac7332b8fb0315a8($context, $indent, $value);
...
';
                ...
                $buffer .= $this->section54fd20bc854b6251b399ae1792026163($context, $indent, $value);
