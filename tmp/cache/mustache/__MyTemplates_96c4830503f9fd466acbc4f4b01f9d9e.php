...
class __MyTemplates_96c4830503f9fd466acbc4f4b01f9d9e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0b980b7478eb3a70e512c2b410bff061($context, $indent, $value);

        return $buffer;
    }

    private function section86e2f80e6bead09e49a69f2744029216(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section0b980b7478eb3a70e512c2b410bff061(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section86e2f80e6bead09e49a69f2744029216($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
