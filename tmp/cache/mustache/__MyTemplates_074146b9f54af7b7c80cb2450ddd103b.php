...
class __MyTemplates_074146b9f54af7b7c80cb2450ddd103b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section811e50fb742e7e68edb5dbfdded80403($context, $indent, $value);
...
';
    ...
    private function sectionD450640126c90a94bd716b617acfdc36(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section811e50fb742e7e68edb5dbfdded80403(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionD450640126c90a94bd716b617acfdc36($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
