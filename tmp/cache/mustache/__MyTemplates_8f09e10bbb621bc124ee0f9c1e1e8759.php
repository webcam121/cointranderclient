...
class __MyTemplates_8f09e10bbb621bc124ee0f9c1e1e8759 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section07152069f1943f57e31599e7968eaacb($context, $indent, $value);
...
';
    ...
    private function section07152069f1943f57e31599e7968eaacb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                            ...
                            <div class="card">
                                <div class="nk-ecwg nk-ecwg6">
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            <div class="card-title">
                                                <h6 class="title">BITL ICO Tokens Information</h6>
                                            </div>
                                        </div>
                                        <div class="data">
...
';
                $buffer .= $indent . '                                            <div class="card-title">
';
                $buffer .= $indent . '                                                <h6 class="title">BITL ICO Tokens Information</h6>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
...
';
                $buffer .= $indent . '                                                <span>sdffsdf</span>
';
                $buffer .= $indent . '                                                <span>sdffsdf</span>
';
                $buffer .= $indent . '                                                <span>sdffsdf</span>
