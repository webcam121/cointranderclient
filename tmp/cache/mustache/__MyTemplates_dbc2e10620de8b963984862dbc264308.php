...
class __MyTemplates_dbc2e10620de8b963984862dbc264308 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB01f104d18a2a9724db577e6a68c6536($context, $indent, $value);
...
';
    ...
    private function sectionB0d5d902794ddfd320b3c2154d2adce7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                            <span>';
                $value = $this->resolveValue($context->find('token_id'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</span>
';
                $buffer .= $indent . '                                        </td>
...
';
                $buffer .= $indent . '                                            <span>';
                $value = $this->resolveValue($context->find('token_amount'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</span>
';
                $buffer .= $indent . '                                        </td>
...
';
    ...
    private function sectionA020af315eabc9340a651db7ca9be112(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionB0d5d902794ddfd320b3c2154d2adce7($context, $indent, $value);
...
';
    ...
    private function sectionB01f104d18a2a9724db577e6a68c6536(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionA020af315eabc9340a651db7ca9be112($context, $indent, $value);
                $buffer .= $indent . '
';
                // 'isTradeList' section
