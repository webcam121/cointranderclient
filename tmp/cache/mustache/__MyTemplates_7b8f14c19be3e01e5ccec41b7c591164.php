...
class __MyTemplates_7b8f14c19be3e01e5ccec41b7c591164 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA6a7e5a75b2b4c2d44d11d0d31006025($context, $indent, $value);
...
';
    ...
    private function sectionA6a7e5a75b2b4c2d44d11d0d31006025(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                ...
                <div class="nk-block">
                    <div class="row g-gs">
                        ...
                        <div class="col-xxl-4 col-sm-4">
                            <div class="card h-100" style="height:628px;">
                                <div class="card-inner">
                                    <div class="card-title-group mb-2">
                                        <div class="card-title">
...
';
                $buffer .= $indent . '                            <div class="card h-100" style="height:628px;">
';
                $buffer .= $indent . '                                <div class="card-inner">
';
                $buffer .= $indent . '                                    <div class="card-title-group mb-2">
