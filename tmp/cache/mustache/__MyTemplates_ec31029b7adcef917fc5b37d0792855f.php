...
class __MyTemplates_ec31029b7adcef917fc5b37d0792855f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9c30649a30125c0602a4bc69ec6a4b6f($context, $indent, $value);
...
';
    ...
    private function section9c30649a30125c0602a4bc69ec6a4b6f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
