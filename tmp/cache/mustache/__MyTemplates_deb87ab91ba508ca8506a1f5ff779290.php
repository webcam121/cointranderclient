...
class __MyTemplates_deb87ab91ba508ca8506a1f5ff779290 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3e6b40c987ffe247d85d168537daf392($context, $indent, $value);
...
';
    ...
    private function section3e6b40c987ffe247d85d168537daf392(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <div class="card-content">
                                        <div class="card-token">
                                            <div class="card-token-item">
                                                <span style="font-size:25px">Amount:</span>
...
';
                $buffer .= $indent . '                                                <span style="font-size:25px">Amount:</span>
';
