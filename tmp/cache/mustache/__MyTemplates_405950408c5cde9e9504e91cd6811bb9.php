...
class __MyTemplates_405950408c5cde9e9504e91cd6811bb9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section252b168199856877c3344eebc1972ba7($context, $indent, $value);

        return $buffer;
    }

    private function section6b5fe88800c32a2abf7ec4d6f3f4f593(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                                        <div class="card-token mt-1">
                                            <div class="card-token__item">
                                                <span class="card_item_title">Tokens:</span>
                                                <span style="font-size: 15px;">{{tokenAmount}}</span>
                                            </div>
                                            <div class="card-token__item">
                                                <span class="card_item_title">Token price:</span>
                                                <span style="font-size: 15px;">{{token_price}}$</span>
                                            </div>
                                            <div class="card-token__item">
                                                <span class="card_item_title">Current Value:</span>
                                                <span style="font-size: 15px;">{{number_format(value, 3, \',\', \' \')}}$</span>
                                            </div>
                                        </div>
                                        ';
...
';
                $buffer .= $indent . '                                                <span class="card_item_title">Tokens:</span>
';
                $buffer .= $indent . '                                                <span style="font-size: 15px;">';
...
';
                $buffer .= $indent . '                                            <div class="card-token__item">
';
                $buffer .= $indent . '                                                <span class="card_item_title">Token price:</span>
';
                $buffer .= $indent . '                                                <span style="font-size: 15px;">';
...
';
                $buffer .= $indent . '                                            <div class="card-token__item">
';
                $buffer .= $indent . '                                                <span class="card_item_title">Current Value:</span>
';
                $buffer .= $indent . '                                                <span style="font-size: 15px;">';
                $value = $this->resolveValue($context->find('number_format(value, 3, \',\', \' \')'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '$</span>
';
                $buffer .= $indent . '                                            </div>
...
';
    ...
    private function section252b168199856877c3344eebc1972ba7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                            <div class="card-title">
';
                $buffer .= $indent . '                                                <h6 class="title">BITL ICO</h6>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
';
                ...
                $buffer .= $this->section6b5fe88800c32a2abf7ec4d6f3f4f593($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
