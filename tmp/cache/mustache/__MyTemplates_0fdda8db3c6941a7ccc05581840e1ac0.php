...
class __MyTemplates_0fdda8db3c6941a7ccc05581840e1ac0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4f4dd97044135a1e2672de4ad75712e4($context, $indent, $value);
...
';
    ...
    private function section4f4dd97044135a1e2672de4ad75712e4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                            ...
                            <div class="card">
                                <div class="nk-ecwg nk-ecwg6">
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            <div class="card-title">
                                                <h6 class="title">                 BITL ICO Tokenssdfsdfsd</h6>
                                            </div>
                                        </div>
                                        <div class="data">
                                            <div class="data-group">
...
';
                $buffer .= $indent . '                                            <div class="card-title">
';
                $buffer .= $indent . '                                                <h6 class="title">                 BITL ICO Tokenssdfsdfsd</h6>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
