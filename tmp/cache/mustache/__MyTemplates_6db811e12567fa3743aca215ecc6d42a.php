...
class __MyTemplates_6db811e12567fa3743aca215ecc6d42a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section79c40ddc7d3910eb062a84681e5460b8($context, $indent, $value);
...
';
    ...
    private function section6a5e67c9420f4707bb129fae52a24fd3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionB4425b68f26a3fe540e1c62ea576fe0f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section6a5e67c9420f4707bb129fae52a24fd3($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function section79c40ddc7d3910eb062a84681e5460b8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->sectionB4425b68f26a3fe540e1c62ea576fe0f($context, $indent, $value);
                $buffer .= $indent . '                                        </tbody>
';
                $buffer .= $indent . '                                    </table>
';
