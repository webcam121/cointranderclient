...
class __MyTemplates_986e38b93b945a80ad5844ad6b1311f9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3f6234f209eab9860cf33b15614c49e7($context, $indent, $value);
...
';
    ...
    private function section437fadaedfa39c59c06f61554a74836a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" name="updateTokenByUser" class="btn btn-primary">
                                                Update Token Price
                                            </button>
                                        </div>
                                        ';
...
';
                $buffer .= $indent . '                                        <div class="col-md-6">
';
                $buffer .= $indent . '                                            <button type="submit" name="updateTokenByUser" class="btn btn-primary">
';
...
';
    ...
    private function section3f6234f209eab9860cf33b15614c49e7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section437fadaedfa39c59c06f61554a74836a($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
