...
class __MyTemplates_c741787568ea538af8897f7cb7c347dd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section347eeb92be878f58f8a7d601e3b2e6bd($context, $indent, $value);
...
';
    ...
    private function sectionEc51e3321c7db61e1283ab6c85367f0c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section347eeb92be878f58f8a7d601e3b2e6bd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionEc51e3321c7db61e1283ab6c85367f0c($context, $indent, $value);
