...
class __MyTemplates_b9459f955f339b88d86c88cca0d3c8e6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5161694ed334342f30e114528cdeb6aa($context, $indent, $value);
...
';
    ...
    private function section5dde80e626f867415713971043f59274(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                            <tr>
                                                <td>{{tradeNumber == 0 ? \'\' : tradeNumber}}</td>
                                                <td>{{dateFormatted}}</td>
                                                {{#coinImg}}
                                                    <td style="padding:0">
                                                    <img src="{{coinImg}}" style="width:38px;margin-left:10px;" alt="coinImg"/>
...
';
                $buffer .= $indent . '                                                <td>';
                $value = $this->resolveValue($context->find('tradeNumber == 0 ? \'\' : tradeNumber'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</td>
';
                $buffer .= $indent . '                                                <td>';
...
';
    ...
    private function section4833d547793ceb3c5b520f328b098b75(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section5dde80e626f867415713971043f59274($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function section5161694ed334342f30e114528cdeb6aa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->section4833d547793ceb3c5b520f328b098b75($context, $indent, $value);
                $buffer .= $indent . '                                        </tbody>
';
                $buffer .= $indent . '                                    </table>
';
