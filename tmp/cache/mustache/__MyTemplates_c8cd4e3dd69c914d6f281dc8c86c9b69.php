...
class __MyTemplates_c8cd4e3dd69c914d6f281dc8c86c9b69 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3e1e49e63aa0fd360842a44139146c14($context, $indent, $value);
...
';
    ...
    private function section3e1e49e63aa0fd360842a44139146c14(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        <div class="width:18%">
';
