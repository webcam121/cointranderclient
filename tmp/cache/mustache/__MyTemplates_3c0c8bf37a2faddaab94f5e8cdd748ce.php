...
class __MyTemplates_3c0c8bf37a2faddaab94f5e8cdd748ce extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7454de8585a63726f22fa9411a0054eb($context, $indent, $value);
...
';
    ...
    private function section7454de8585a63726f22fa9411a0054eb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                        ...
                        <div class="col-xxl-12 col-sm-12">
                            <div class="card card-preview">
                                <div class="card-inner">
                                    ...
                                    <div class="card-content">sdfsfd</div>
...
';
                $buffer .= $indent . '                                    
';
                $buffer .= $indent . '                                    <div class="card-content">sdfsfd</div>
';
                $buffer .= $indent . '
';
