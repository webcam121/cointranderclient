...
class __MyTemplates_3aed828daab1fc9076abdf7a87f074c8 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4271a6c4694de7bd19379897f3b97150($context, $indent, $value);
...
';
    ...
    private function section4271a6c4694de7bd19379897f3b97150(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
