...
class __MyTemplates_3d2bb92e7636def6114c8df88296fd40 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9d410c2456230a3ebe93d9962a3e61ce($context, $indent, $value);
...
';
    ...
    private function section9d410c2456230a3ebe93d9962a3e61ce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                      
';
                $buffer .= $indent . '                        <div style="col-xxl-2 col-sm-12">
';
