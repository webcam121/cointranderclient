...
class __MyTemplates_0bd81d72692f599156bc52cb31e69a00 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6dc552f488241866c28ef366aa2fe30a($context, $indent, $value);
...
';
    ...
    private function section8af24131dd5c6b389f509330cf243747(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section669846053156e9891a9c4cbeaa325c4a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section8af24131dd5c6b389f509330cf243747($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function section6dc552f488241866c28ef366aa2fe30a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->section669846053156e9891a9c4cbeaa325c4a($context, $indent, $value);
                $buffer .= $indent . '                                        </tbody>
';
                $buffer .= $indent . '                                    </table>
';
