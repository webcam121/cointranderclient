...
class __MyTemplates_79ca902a9c4d48764aa01a09c2be468f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBe9614fa57915faba5713541556c2c2b($context, $indent, $value);
...
';
    ...
    private function sectionBe9614fa57915faba5713541556c2c2b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-group">
                                                        <input type="text" id="initialInvestment" min="$1000" placeholder="Minimum Investment is $1000" class="form-control form-control-lg" value="1000" readonly>
                                    ...
                                    <div class="nk-kycfm-footer">
                                        <div class="form-group">
                                            <div class="custom-control custom-control-xs custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="tc-agree">I Have Read The <a href="https://www.cointrader24.io/terms-of-service">Terms & Policy</a></label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-control-xs custom-checkbox">
        ...
        <div class="container-xl wide-lg">
            <div class="nk-footer-wrap">
                ...
                <div class="nk-footer-links">
                    <ul class="nav nav-sm">
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.cointrader24.io/terms-of-service">Terms & Policy</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.cointrader24.io/faq">FAQ</a>
                        </li>
                    </ul>
                </div>
            </div>
...
';
                $buffer .= $indent . '                                                    <div class="form-control-group">
';
                $buffer .= $indent . '                                                        <input type="text" id="initialInvestment" min="$1000" placeholder="Minimum Investment is $1000" class="form-control form-control-lg" value="1000" readonly>
';
...
';
                $buffer .= $indent . '                                                <label class="custom-control-label" for="tc-agree">I Have Read The <a href="https://www.cointrader24.io/terms-of-service">Terms & Policy</a></label>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
...
';
                $buffer .= $indent . '                            <a class="nav-link" href="https://www.cointrader24.io/terms-of-service">Terms & Policy</a>
';
                $buffer .= $indent . '                        </li>
';
                $buffer .= $indent . '                        <li class="nav-item">
';
                $buffer .= $indent . '                            <a class="nav-link" href="https://www.cointrader24.io/faq">FAQ</a>
';
                $buffer .= $indent . '                        </li>
';
                $buffer .= $indent . '                    </ul>
