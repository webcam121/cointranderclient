...
class __MyTemplates_54a942d7e8b799e5b73ebf63787dcb59 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6fe661bcdbc73fc737316c73e2702ab9($context, $indent, $value);
...
';
    ...
    private function section6fe661bcdbc73fc737316c73e2702ab9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                        {
';
                $buffer .= $indent . '                                            "proName": "BITSTAMP:BNBUSD",
';
