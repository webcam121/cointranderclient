...
class __MyTemplates_abd3648766854f0cea52c71fc5af9d31 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9fc48cfbaef31b03f63b4d529ff5486a($context, $indent, $value);
...
';
    ...
    private function section9fc48cfbaef31b03f63b4d529ff5486a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                        ...
                        <div class="col-xxl-12 col-sm-12">
                            <div class="card card-preview">
                                <div class="card-inner">
                                    ...
                                    <div class="card-content-group">sdfsfd</div>
...
';
                $buffer .= $indent . '                                    
';
                $buffer .= $indent . '                                    <div class="card-content-group">sdfsfd</div>
';
                $buffer .= $indent . '
';
