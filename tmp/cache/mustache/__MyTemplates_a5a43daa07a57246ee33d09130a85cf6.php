...
class __MyTemplates_a5a43daa07a57246ee33d09130a85cf6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section58bfcb39f21b7611a03a88e34ad148d2($context, $indent, $value);

        return $buffer;
    }

    private function sectionA679a7d94c3c1a8671fccf201a94041f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section58bfcb39f21b7611a03a88e34ad148d2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionA679a7d94c3c1a8671fccf201a94041f($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
