...
class __MyTemplates_f5a403825e062f021e39481dd61979c4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section90eddce6123bbc0ea3ae293cb4c6a4de($context, $indent, $value);
...
';
    ...
    private function section90eddce6123bbc0ea3ae293cb4c6a4de(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
