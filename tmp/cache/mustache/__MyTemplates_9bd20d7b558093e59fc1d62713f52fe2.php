...
class __MyTemplates_9bd20d7b558093e59fc1d62713f52fe2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD9c22721897ca1ff6cbfc575d2956c06($context, $indent, $value);
...
';
    ...
    private function sectionD9c22721897ca1ff6cbfc575d2956c06(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <form action="#" class="buysell-form">
                                    ...
                                    <div class="buysell-field form-group">
                                        ...
                                        <div class="form-control-group">
                                            <input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="1000" placeholder="Min Amount is 1000">
                                            ...
                                            <ul class="buysell-pm-list withdrawMethod">
                                                <li class="buysell-pm-item">
                                                    ...
                                                    <label class="buysell-pm-label" for="debitCard">
                                                        <span class="pm-name">Cointrader24 Debit Card</span>
                                                        <span class="pm-icon"><em class="icon ni ni-cc-alt2"></em></span>
                                                    </label>
                                                </li>
                                                <!--<li class="buysell-pm-item">
                                                ...
                                                <li class="buysell-pm-item">
                                                    <input class="buysell-pm-control" type="radio" name="bs-method" data="cryptoCurrency" id="cryptoCurrency1" checked/>
...
';
                $buffer .= $indent . '                                            <input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="1000" placeholder="Min Amount is 1000">
';
...
';
                $buffer .= $indent . '                                                        <span class="pm-name">Cointrader24 Debit Card</span>
';
                $buffer .= $indent . '                                                        <span class="pm-icon"><em class="icon ni ni-cc-alt2"></em></span>
';
                $buffer .= $indent . '                                                    </label>
...
';
                $buffer .= $indent . '                                                <li class="buysell-pm-item">
';
                $buffer .= $indent . '                                                    <input class="buysell-pm-control" type="radio" name="bs-method" data="cryptoCurrency" id="cryptoCurrency1" checked/>
';
