...
class __MyTemplates_f2b0e6fc40da2351b3a02d9961e24587 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section35f307706fc401d3018ada22a86f7ccf($context, $indent, $value);
...
';
    ...
    private function section35f307706fc401d3018ada22a86f7ccf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                            <div class="card-box__item">
';
