...
class __MyTemplates_29e9b86d1b26087d1ae85d64412e8514 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB1f13b2b2ae8897b15b7f476d4d75912($context, $indent, $value);
...
';
    ...
    private function sectionB1f13b2b2ae8897b15b7f476d4d75912(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                        ...
                        <div class="col-xxl-12 col-sm-12 www">
                        
                      
                        <div class="" style="flex-basic:23%">
                            <div class="card">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '                        <div class="col-xxl-12 col-sm-12 www">
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      
';
                $buffer .= $indent . '                        <div class="" style="flex-basic:23%">
';
