...
class __MyTemplates_d60f0eaa4972a4e88e1fd101671dc4ba extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC5cc00853ecbd8c9435e6e31ca252806($context, $indent, $value);
...
';
    ...
    private function sectionC5cc00853ecbd8c9435e6e31ca252806(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="display:flex; flex-wrap:wrap">
';
