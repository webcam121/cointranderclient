...
class __MyTemplates_5ac4b1a36d3b141de1bb9afbccb2a516 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF197363b6b024dcb6ce3780d012cb22e($context, $indent, $value);
...
';
    ...
    private function sectionF197363b6b024dcb6ce3780d012cb22e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="nk-kycfm">
                                    ...
                                    <div class="nk-kycfm-head">
                                        ...
                                        <div class="nk-kycfm-title">
                                            ...
                                            <p class="sub-title">Choose the algorithm you want to start with.</p>
                                        </div>
                                    </div>
                                    <div class="nk-kycfm-content">
                                        <div class="row g-4">
...
';
                $buffer .= $indent . '                                            <p class="sub-title">Choose the algorithm you want to start with.</p>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </div>
