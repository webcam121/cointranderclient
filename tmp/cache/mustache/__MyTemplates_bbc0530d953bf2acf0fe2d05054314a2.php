...
class __MyTemplates_bbc0530d953bf2acf0fe2d05054314a2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9e52acaf594df4511799b95f1b4ac5cc($context, $indent, $value);
...
';
    ...
    private function section9e52acaf594df4511799b95f1b4ac5cc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                      
';
                $buffer .= $indent . '                        <div class="" style="width:15%">
';
