...
class __MyTemplates_fc36fc328a6cf6a781f028d18931d8f8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9b47492548ea37697428ef678d65cf00($context, $indent, $value);

        return $buffer;
    }

    private function section0101b7ea1b899719e711c11870fe31df(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                                        <div class="card-token mt-1">
                                            ...
                                            <div class="card-token__item">
                                                ...
                                                <span>echo({{tokenAmount}} * {{token_price}})</span>
                                            </div>
                                        </div>
                                        ';
...
';
    ...
    private function section9b47492548ea37697428ef678d65cf00(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section0101b7ea1b899719e711c11870fe31df($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
