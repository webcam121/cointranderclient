...
class __MyTemplates_5c6189b0173ad9362294345450a64926 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                            <img class="logo-light logo-img logo-img-lg" src="./assets/images/logo-dark2x.png" srcset="./assets/images/dark2x.png 2x" alt="logo">
';
