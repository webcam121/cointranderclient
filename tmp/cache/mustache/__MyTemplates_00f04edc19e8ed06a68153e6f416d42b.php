...
class __MyTemplates_00f04edc19e8ed06a68153e6f416d42b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section771c7fc5b1cbe958816cf5c5b62da70c($context, $indent, $value);
...
';
    ...
    private function section771c7fc5b1cbe958816cf5c5b62da70c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <div class="card-content mb-5">
                                        <div class="card-token">
                                            <div class="card-token-item">
                                                <span class="pr-5" style="font-size:18px;">Amount:</span>
...
';
                $buffer .= $indent . '                                                <span class="pr-5" style="font-size:18px;">Amount:</span>
';
