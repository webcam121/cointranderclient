...
class __MyTemplates_908e0c1a51b88aeaeddbd33c29c83b1c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section35caefc7bc0fe35b23f21d368c5b6119($context, $indent, $value);

        return $buffer;
    }

    private function section35caefc7bc0fe35b23f21d368c5b6119(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                            ...
                            <div id="depositDiv" class="buysell-block">
                                <form action="#" class="buysell-form">
                                    ...
                                    <div class="buysell-field form-action">
                                        <a href="#" id="continueDeposit" class="btn btn-lg btn-block btn-info" data-toggle="modal" data-target="#depositModal">Upgrade Account</a>
                                    </div>
                                </form>
                            </div>
...
';
                $buffer .= $indent . '                                        <a href="#" id="continueDeposit" class="btn btn-lg btn-block btn-info" data-toggle="modal" data-target="#depositModal">Upgrade Account</a>
';
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </form>
