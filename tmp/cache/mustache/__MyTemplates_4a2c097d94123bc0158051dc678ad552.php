...
class __MyTemplates_4a2c097d94123bc0158051dc678ad552 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF0d5700fcf0444bef294c360002cafb6($context, $indent, $value);
...
';
    ...
    private function sectionF0d5700fcf0444bef294c360002cafb6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                        ...
                        <div class="card-box">
                            <div class="card-box__item col-xxl-2 col-sm-6">
                                <div class="card">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '.card-box__item {
';
                $buffer .= $indent . '    flex-basis:25%
';
                $buffer .= $indent . '}
';
                $buffer .= $indent . '
...
';
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div class="card-box">
';
                $buffer .= $indent . '                            <div class="card-box__item col-xxl-2 col-sm-6">
';
...
';
                $buffer .= $indent . '                            </div>
';
                $buffer .= $indent . '                            <div class="col-xxl-2 col-sm-6">
';
                $buffer .= $indent . '                                <div class="card">
';
                $buffer .= $indent . '                                    <div class="nk-ecwg nk-ecwg6">
