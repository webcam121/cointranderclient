...
class __MyTemplates_930a696e678821670285da4bebb4fb03 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8e4b5b8d4294f504b50ed902124f976b($context, $indent, $value);
...
';
    ...
    private function section8e4b5b8d4294f504b50ed902124f976b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
