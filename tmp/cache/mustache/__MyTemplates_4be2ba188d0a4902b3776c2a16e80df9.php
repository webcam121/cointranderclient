...
class __MyTemplates_4be2ba188d0a4902b3776c2a16e80df9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7f99971f19efbf6157e56d617ba52dba($context, $indent, $value);
...
';
    ...
    private function section7f99971f19efbf6157e56d617ba52dba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <div class="card-content mb-5">
                                        <div class="card-token">
                                            <div class="card-token-item">
                                                <span style="font-size:18px; min-width:150px">Amount:</span>
                                                <span style="font-size:18px;">25000 BITL</span>
                                            </div>
                                            <div class="card-token-item">
                                                <span style="font-size:20px">Token price:</span>
                                                <span style="font-size:18px;">$0.05</span>
                                            </div>
                                            <div class="card-token-item">
                                                <span style="font-size:20px">Current Value:</span>
...
';
                $buffer .= $indent . '                                                <span style="font-size:18px; min-width:150px">Amount:</span>
';
...
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span style="font-size:20px">Token price:</span>
';
...
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span style="font-size:20px">Current Value:</span>
';
