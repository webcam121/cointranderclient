...
class __MyTemplates_da71adce3ad36d2c3b6beac4c17d0421 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section569356748d0d77528d9460fa5887a46c($context, $indent, $value);
...
';
    ...
    private function sectionA0f2e3a8dd7ce2d181ccb9c7d8ca394d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section569356748d0d77528d9460fa5887a46c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
        ...
        <div class="nk-block-head" style="margin-top: 30px;">
            <div class="nk-block-between-md g-4">
                <div class="nk-block-head-content">
                    <h5 class="nk-block-title">Client Account Overview</h5>
                </div>
               <div class="nk-block-head-content">
                    ...
                    <div class="card-inner">
                        <div class="account-overview">
                            ...
                            <div class="account-overview__item" style="margin-right:50px;">
                                <div class="account-overview__content">
                                    <div class="nk-iv-wg3-title">Account Performance <em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Profit This Month"></em></div>
            ...
            <div class="card card-bordered">
                <div id="schemeDetails" class="nk-iv-scheme-details">
                    ...
                    <ul class="nk-iv-wg3-list">
                        ...
                        <li>
                            <div class="sub-text">Debit Card Access</div>
...
';
                $buffer .= $indent . '                    <h5 class="nk-block-title">Client Account Overview</h5>
';
                $buffer .= $indent . '                </div>
';
                $buffer .= $indent . '               <div class="nk-block-head-content">
...
';
                $buffer .= $indent . '                                <div class="account-overview__content">
';
                $buffer .= $indent . '                                    <div class="nk-iv-wg3-title">Account Performance <em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Profit This Month"></em></div>
';
...
';
                $buffer .= $indent . '                        <li>
';
                $buffer .= $indent . '                            <div class="sub-text">Debit Card Access</div>
';
                $buffer .= $indent . '                            <div class="lead-text">';
...
';
                ...
                $buffer .= $this->sectionA0f2e3a8dd7ce2d181ccb9c7d8ca394d($context, $indent, $value);
                $buffer .= $indent . '                </div>
';
                $buffer .= $indent . '            </div>
';
