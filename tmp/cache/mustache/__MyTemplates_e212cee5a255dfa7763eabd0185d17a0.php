...
class __MyTemplates_e212cee5a255dfa7763eabd0185d17a0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                            <img class="logo-light logo-img logo-img-lg" src="./assets/images/logo-dark2x.png" srcset="./assets/images/logo-dark2x.png 2x" alt="logo">
';
        $buffer .= $indent . '                            <img class="logo-dark logo-img logo-img-lg" src="./assets/images/logo-dark2x.png" srcset="./assets/images/logo-dark2x.png 2x" alt="logo-dark">
';
        $buffer .= $indent . '                        </a>
';
        $buffer .= $indent . '                    </div>
...
';
        $buffer .= $indent . '                                <p>Access your CoinTrader24 account using your email and password</p>
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                        </div>
...
';
        $buffer .= $indent . '                                </a>
';
        $buffer .= $indent . '                                <input type="password" class="form-control form-control-lg" name="password" id="password" placeholder="Enter your Password" required>
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                        </div>
';
        ...
        $buffer .= $indent . '                        <div class="form-group">
';
        $buffer .= $indent . '                            <button type="submit" class="btn btn-lg btn-primary btn-block">Login</button>
';
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '                    </form>
...
';
        $buffer .= $indent . '                        <a href="./register" class="btn btn-lg btn-info btn-block">Register</a>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
...
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://www.cointrader24.io/terms-of-service/"target="_blank">Terms of Service</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://www.cointrader24.io/privacy-policy/"target="_blank">Privacy Policy</a>
';
        $buffer .= $indent . '                                  <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://www.cointrader24.io/faq/"target="_blank">FAQ</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            </li>
...
';
        $buffer .= $indent . '                        <p>&copy; 2022 CoinTrader24.io All Rights Reserved.</p>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
...
';
        $buffer .= $indent . '                                    <h4>CoinTrader24 Online</h4>
';
        $buffer .= $indent . '                                    <p>Cryptocurrency works harder and smarter with <br> CoinTrader24</p>
';
        $buffer .= $indent . '                                </div>
';
        $buffer .= $indent . '                            </div>
