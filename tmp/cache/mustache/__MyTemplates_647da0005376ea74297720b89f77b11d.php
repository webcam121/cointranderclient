...
class __MyTemplates_647da0005376ea74297720b89f77b11d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9c56320bc87dc3e5eed83cd692846833($context, $indent, $value);

        return $buffer;
    }

    private function section8eca93af2fa6b202cccb432a12184810(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9c56320bc87dc3e5eed83cd692846833(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section8eca93af2fa6b202cccb432a12184810($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
