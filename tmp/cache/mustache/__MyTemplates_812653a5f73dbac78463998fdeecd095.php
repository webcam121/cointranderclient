...
class __MyTemplates_812653a5f73dbac78463998fdeecd095 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA894e20f70c6e8b3d06571be62cde775($context, $indent, $value);
...
';
    ...
    private function sectionA894e20f70c6e8b3d06571be62cde775(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
<div class="nk-content layout">
    <div class="container-fluid">
        <div class="nk-block-head" style="margin-top: 30px;">
            <div class="nk-block-between-md g-4">
                <div class="nk-block-head-content">
                    <h5 class="nk-block-title">Account Overview</h5>
                </div>
                <div class="nk-block-head-content">
                    <ul class="nk-block-tools gx-3">
                        ...
                        <li><a href="/clinetAccountOfAgent" class="btn btn-secondary pl-3 pr-3"><span>Client Account</span> <em class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="account-overview__item" >
                                <div class="account-overview__content">
                                    ...
                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                        <div class="nk-iv-wg3-sub">
                                            <div class="nk-iv-wg3-amount">
                                                <div class="number">{{currency}}{{percentageReturn}}</div>
                                            </div>
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div class="nk-content layout">
';
...
';
                $buffer .= $indent . '                    <h5 class="nk-block-title">Account Overview</h5>
';
                $buffer .= $indent . '                </div>
';
                $buffer .= $indent . '                <div class="nk-block-head-content">
...
';
                $buffer .= $indent . '                        <li><a href="/clinetAccountOfAgent" class="btn btn-secondary pl-3 pr-3"><span>Client Account</span> <em class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
';
                $buffer .= $indent . '                    </ul>
';
                $buffer .= $indent . '                </div>
