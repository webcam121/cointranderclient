...
class __MyTemplates_4e0046612b6511a8d11e2f4e51339cb0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBb41a8766ef7ef4776cd2e197670edb6($context, $indent, $value);
...
';
    ...
    private function sectionBb41a8766ef7ef4776cd2e197670edb6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                      ...
                      <div style="display: flex; flex-wrap: wrap; justify-content:space-beetween">
                        <div style="width:18%;flex-grow:1">
                            <div class="card">
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="display: flex; flex-wrap: wrap; justify-content:space-beetween">
';
                $buffer .= $indent . '                        <div style="width:18%;flex-grow:1">
';
