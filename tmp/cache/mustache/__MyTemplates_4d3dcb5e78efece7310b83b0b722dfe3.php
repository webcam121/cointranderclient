...
class __MyTemplates_4d3dcb5e78efece7310b83b0b722dfe3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9859b4276eaa3926f091af405b1a9527($context, $indent, $value);
...
';
    ...
    private function section9859b4276eaa3926f091af405b1a9527(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="card-content-group mb-2">
                                        <div class="card-content">
                                            <span class="title pr-10">Amount:</span> <span>25000BITL</span>
                                        </div>
                                        <div class="card-content">
...
';
                $buffer .= $indent . '                                            <span class="title pr-10">Amount:</span> <span>25000BITL</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <div class="card-content">
