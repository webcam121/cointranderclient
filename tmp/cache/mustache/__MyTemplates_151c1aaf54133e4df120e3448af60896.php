...
class __MyTemplates_151c1aaf54133e4df120e3448af60896 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1288cc40adf25d7421216692b58cec53($context, $indent, $value);
...
';
    ...
    private function section1288cc40adf25d7421216692b58cec53(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="display:flex; justify-content:space-beetween">
';
