...
class __MyTemplates_151b528a09607b5b6f82ad0621217685 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section694a1a5a1701ec64205867ce88914458($context, $indent, $value);
...
';
    ...
    private function section0948d39a68b4a96299a607b351928ad3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section694a1a5a1701ec64205867ce88914458(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section0948d39a68b4a96299a607b351928ad3($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
