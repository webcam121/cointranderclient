...
class __MyTemplates_83c35e990e312f848cb7bebe4e097f84 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0718c6781d22d99c9fdc4988e44270fc($context, $indent, $value);
...
';
    ...
    private function section1fad1436a16b6cab206210968c3f553a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <form method="post" action="/adminTradesByUser" enctype="multipart/form-data" class="row gy-3">
                                       ...
                                       <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" id="accountType" value="{{tokenAmount}}" name="accountType" class="form-control form-control-lg form-control-outlined" readonly>
...
';
    ...
    private function section0718c6781d22d99c9fdc4988e44270fc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section1fad1436a16b6cab206210968c3f553a($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
