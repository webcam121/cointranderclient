...
class __MyTemplates_82181026b981204f1f76202b9c6a5ced extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section766545b7386dc55cea029d15a632e76b($context, $indent, $value);
...
';
    ...
    private function section766545b7386dc55cea029d15a632e76b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                           {
';
                $buffer .= $indent . '                                            "proName": "BINANCE:BNBUSDT",
';
