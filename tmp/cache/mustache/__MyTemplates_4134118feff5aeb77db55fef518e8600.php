...
class __MyTemplates_4134118feff5aeb77db55fef518e8600 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD560eb8a20f77fbb39e32a495318c7b7($context, $indent, $value);
...
';
    ...
    private function sectionE3effc6fd78b4e305e4c2b2e6fc30063(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionD560eb8a20f77fbb39e32a495318c7b7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionE3effc6fd78b4e305e4c2b2e6fc30063($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
