...
class __MyTemplates_4196e70bedb85163c0bc2dddb7bfccfe extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB76a2d18bfbb340c9eee51363df07671($context, $indent, $value);
...
';
    ...
    private function sectionB76a2d18bfbb340c9eee51363df07671(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        <div class="" style="width:18%">
';
