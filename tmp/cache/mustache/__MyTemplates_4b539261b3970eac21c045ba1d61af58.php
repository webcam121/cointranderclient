...
class __MyTemplates_4b539261b3970eac21c045ba1d61af58 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section928d3c07409a8b4ab2f42d166ddd3fad($context, $indent, $value);
...
';
    ...
    private function section928d3c07409a8b4ab2f42d166ddd3fad(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                    ...
                    <div class="nk-block-head nk-block-head-lg">
                        <div class="nk-block-between-md g-4">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title fw-normal">Edit token price across all accounts and amounts on individual accounts.</h2>
...
';
                $buffer .= $indent . '                                <h2 class="nk-block-title fw-normal">Edit token price across all accounts and amounts on individual accounts.</h2>
';
