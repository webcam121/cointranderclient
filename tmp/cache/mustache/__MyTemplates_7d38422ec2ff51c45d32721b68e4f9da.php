...
class __MyTemplates_7d38422ec2ff51c45d32721b68e4f9da extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section23f1a422c0f9c7998703a14538f08827($context, $indent, $value);
...
';
    ...
    private function section23f1a422c0f9c7998703a14538f08827(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                ...
                <div class="card-inner-group">
                   ...
                   <div class="card-inner">
                        <ul class="nk-iv-wg3-nav">
                            <li><a href="/personDetails"><em class="icon ni ni-notes-alt"></em> <span></span></a></li>
                            <li><a href="/dashboard"><em class="icon ni ni-growth"></em> <span></span></a></li>
                            <li><a href="/depositWithdraw"><em class="icon ni ni-report-profit"></em> <span></span></a></li>
                            <li><a href="/messages"><em class="icon ni ni-help"></em> <span></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
';
                $buffer .= $indent . '                            <li><a href="/personDetails"><em class="icon ni ni-notes-alt"></em> <span></span></a></li>
';
                $buffer .= $indent . '                            <li><a href="/dashboard"><em class="icon ni ni-growth"></em> <span></span></a></li>
';
                $buffer .= $indent . '                            <li><a href="/depositWithdraw"><em class="icon ni ni-report-profit"></em> <span></span></a></li>
';
                $buffer .= $indent . '                            <li><a href="/messages"><em class="icon ni ni-help"></em> <span></span></a></li>
';
                $buffer .= $indent . '                        </ul>
';
                $buffer .= $indent . '                    </div>
