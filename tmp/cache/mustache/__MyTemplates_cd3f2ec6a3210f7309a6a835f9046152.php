...
class __MyTemplates_cd3f2ec6a3210f7309a6a835f9046152 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6d03822ffffb7767d2aa7478a6d8cb75($context, $indent, $value);
...
';
    ...
    private function section6d03822ffffb7767d2aa7478a6d8cb75(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-group">
                                                        <input type="text" id="initialInvestment" min="$1000" placeholder="Minimum Investment is $1000" class="form-control form-control-lg" required>
...
';
                $buffer .= $indent . '                                                    <div class="form-control-group">
';
                $buffer .= $indent . '                                                        <input type="text" id="initialInvestment" min="$1000" placeholder="Minimum Investment is $1000" class="form-control form-control-lg" required>
';
