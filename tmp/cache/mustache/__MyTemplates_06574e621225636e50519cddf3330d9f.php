...
class __MyTemplates_06574e621225636e50519cddf3330d9f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section48d8803d750b5e493a02e966963f831c($context, $indent, $value);

        return $buffer;
    }

    private function section2e9078e9c6ad70ab37d64711885108a1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section35e33dc8b372bc7558cc419561e80dc3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section2e9078e9c6ad70ab37d64711885108a1($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function section48d8803d750b5e493a02e966963f831c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->section35e33dc8b372bc7558cc419561e80dc3($context, $indent, $value);
                $buffer .= $indent . '                        </tbody>
';
                $buffer .= $indent . '                    </table>
';
