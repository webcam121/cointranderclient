...
class __MyTemplates_055f1e8937e2f9324e36756038e594fd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2099db74ffae9544ce2530f90355ebb0($context, $indent, $value);
...
';
    ...
    private function sectionE428cf113128860a8f7764184bf1d455(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '<a href="/adminTokenByAllAccount?delete=true&id={{id}}&userId={{tradeUserId}}" class="btn btn-danger"> Delete Trade Value </a>';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '<a href="/adminTokenByAllAccount?delete=true&id=';
    ...
    private function section2099db74ffae9544ce2530f90355ebb0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <thead class="tb-member-head thead-light">
                                    <tr class="tb-member-item">
                                        ...
                                        <th class="tb-member-type tb-col-sm">
                                            <span class="overline-title">Token Type</span>
                                        </th>
                                        <th class="tb-member-type tb-col-sm">
                                            <span class="overline-title">Token Amount</span>
                                        </th>
                                        <th class="tb-member-role tb-col-md">
                                            <span class="overline-title">Token Date</span>
                                        </th>
                                    ...
                                    <tr class="tb-member-item">
                                        <td class="tb-member-info">
                                            <div class="user-card">
                                                ...
                                                <div class="user-info">
                                                    <span class="lead-text">test &nbsp; esfd</span>
                                                    <span class="sub-text">admin@cointrader24.io</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="tb-member-role tb-col-md">
                                            <span>16-09-2022 21:10:08</span>
                                        </td>
                                        <td class="tb-member-action">
                                            <div class="d-none d-md-inline">
                                                <a href="/adminTokenByAllAccount?userId={{id}}" class="link link-sm"><span>Edit Token Amount</span></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="tb-member-item">
                                        <td class="tb-member-info">
                                            <div class="user-card">
                                                ...
                                                <div class="user-info">
                                                    <span class="lead-text">Viktor &nbsp; Denisov</span>
                                                    <span class="sub-text">denisovviktor1969@gmail.com</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="tb-member-type tb-col-sm">
                            ...
                            <table class="table table-member">
                                ...
                                <tbody class="tb-member-body">
                                    ...
                                    <tr class="tb-member-item">
                                        ...
                                        <td class="tb-member-action">
                                            <div class="d-none d-md-inline">
                                                <a href="/adminTokenByAllAccount?id={{id}}&userId={{userId}}" class="link link-sm"><span>View Trade</span></a>
                                                <a href="/adminTokenByAllAccount?id={{id}}&userId={{userId}}&delete=true" class="link link-sm link-danger"><span>Delete Trade</span></a>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <div class="preview-block">
                                    <form method="post" action="/adminTokenByAllAccount" enctype="multipart/form-data" class="row gy-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            {{#trade}}<a href="/adminTokenByAllAccount?delete=true&id={{id}}&userId={{tradeUserId}}" class="btn btn-danger"> Delete Trade Value </a>{{/trade}}
                                        </div>
                                    </form>
                                </div>
                            </div>
...
';
                $buffer .= $indent . '                                            <span class="overline-title">Token Type</span>
';
                $buffer .= $indent . '                                        </th>
';
                $buffer .= $indent . '                                        <th class="tb-member-type tb-col-sm">
...
';
                $buffer .= $indent . '                                            <span class="overline-title">Token Date</span>
';
                $buffer .= $indent . '                                        </th>
';
...
';
                $buffer .= $indent . '                                                    <span class="lead-text">test &nbsp; esfd</span>
';
                $buffer .= $indent . '                                                    <span class="sub-text">admin@cointrader24.io</span>
';
                $buffer .= $indent . '                                                </div>
';
                $buffer .= $indent . '                                            </div>
...
';
                $buffer .= $indent . '                                            <span>BITL</span>
';
                $buffer .= $indent . '                                        </td>
';
                $buffer .= $indent . '                                        <td class="tb-member-type tb-col-sm">
';
                $buffer .= $indent . '                                            <span>100</span>
';
                $buffer .= $indent . '                                        </td>
';
                $buffer .= $indent . '                                        <td class="tb-member-role tb-col-md">
';
                $buffer .= $indent . '                                            <span>16-09-2022 21:10:08</span>
';
                $buffer .= $indent . '                                        </td>
';
...
';
                ...
                $value = $this->resolveValue($context->find('id'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" class="link link-sm"><span>Edit Token Amount</span></a>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </td>
...
';
                $buffer .= $indent . '                                                <div class="user-info">
';
                $buffer .= $indent . '                                                    <span class="lead-text">Viktor &nbsp; Denisov</span>
';
                $buffer .= $indent . '                                                    <span class="sub-text">denisovviktor1969@gmail.com</span>
';
                $buffer .= $indent . '                                                </div>
';
                $buffer .= $indent . '                                            </div>
...
';
                $buffer .= $indent . '                                        <td class="tb-member-role tb-col-md">
';
                $buffer .= $indent . '                                            <span>20-10-2022 23:28:13</span>
';
                $buffer .= $indent . '                                        </td>
';
                $buffer .= $indent . '                                        <td class="tb-member-action">
...
';
                $buffer .= $indent . '                                            <div class="d-none d-md-inline">
';
                $buffer .= $indent . '                                                <a href="/adminTokenByAllAccount?id=';
                $value = $this->resolveValue($context->find('id'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '&userId=';
...
';
                ...
                // 'trade' section
                $value = $context->find('trade');
                $buffer .= $this->sectionE428cf113128860a8f7764184bf1d455($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '                                        </div>
';
