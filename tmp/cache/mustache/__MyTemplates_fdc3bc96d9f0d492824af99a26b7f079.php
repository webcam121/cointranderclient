...
class __MyTemplates_fdc3bc96d9f0d492824af99a26b7f079 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6df6390c196f82f1103533a41b87d095($context, $indent, $value);
...
';
    ...
    private function section027e3dda202d287dd73f5ac44443db79(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section6df6390c196f82f1103533a41b87d095(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section027e3dda202d287dd73f5ac44443db79($context, $indent, $value);
                $context->pop();
            }
        }
