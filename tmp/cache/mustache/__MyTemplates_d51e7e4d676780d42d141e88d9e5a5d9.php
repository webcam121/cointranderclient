...
class __MyTemplates_d51e7e4d676780d42d141e88d9e5a5d9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAa2567d7f26e5b2a8b7e4b26fa1ba18e($context, $indent, $value);
...
';
    ...
    private function sectionAa2567d7f26e5b2a8b7e4b26fa1ba18e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                      ...
                      <div class="row">
                        <div class="col-xxl-2-5 col-sm-12">
                            <div class="card">
...
';
                $buffer .= $indent . '                        <div class="col-xxl-2-5 col-sm-12">
';
