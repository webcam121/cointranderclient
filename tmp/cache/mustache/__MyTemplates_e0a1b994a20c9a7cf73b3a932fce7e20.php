...
class __MyTemplates_e0a1b994a20c9a7cf73b3a932fce7e20 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section34864e115bc2079d4e9bca42cb83f6ac($context, $indent, $value);
...
';
    ...
    private function sectionB959c1942220325d479fec239571b074(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section55cac947ed8a19ee49c05f91a47e96e2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'getAgentUsers' section
                $value = $context->find('getAgentUsers');
                $buffer .= $this->sectionB959c1942220325d479fec239571b074($context, $indent, $value);
                $buffer .= $indent . '                                                                         
';
                $buffer .= $indent . '                                                                    </select>
';
...
';
    ...
    private function section34864e115bc2079d4e9bca42cb83f6ac(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section55cac947ed8a19ee49c05f91a47e96e2($context, $indent, $value);
                $context->pop();
            }
        }
