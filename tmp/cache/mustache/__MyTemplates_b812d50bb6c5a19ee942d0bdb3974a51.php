...
class __MyTemplates_b812d50bb6c5a19ee942d0bdb3974a51 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBf82b28b2ed01443e640f7138af70852($context, $indent, $value);
...
';
    ...
    private function sectionBf82b28b2ed01443e640f7138af70852(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <form action="#" class="buysell-form">
                                    ...
                                    <div class="buysell-field form-group">
                                        ...
                                        <div class="form-control-group">
                                            <input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="300" placeholder="Min Amount is 300">
...
';
                $buffer .= $indent . '                                            <input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="300" placeholder="Min Amount is 300">
';
