...
class __MyTemplates_44f7989b33ae3ea20b60bff7bc7b05ef extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section05315ea330dad0b39a00ae8583eec6ad($context, $indent, $value);
...
';
    ...
    private function section05315ea330dad0b39a00ae8583eec6ad(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <div class="card-content mb-5">
                                        <div class="card-token">
                                            <div class="card-token-item">
                                                <span class="pr-10" style="font-size:18px;">Amount:</span>
                                                <span style="font-size:18px;">25000 BITL</span>
                                            </div>
                                            <div class="card-token-item">
                                                <span class="pr-5" style="font-size:18px">Token price:</span>
                                                <span style="font-size:18px;">$0.05</span>
                                            </div>
                                            <div class="card-token-item">
                                                <span class="pr-4" style="font-size:18px">Current Value:</span>
                                                <span style="font-size:18px;">$1250</span>
                                            </div>
                                        </div>
                                    </div>
...
';
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div class="col-xxl-3 col-sm-6">
';
...
';
                $buffer .= $indent . '                                    
';
                $buffer .= $indent . '                                    <div class="card-content mb-5">
';
                $buffer .= $indent . '                                        <div class="card-token">
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span class="pr-10" style="font-size:18px;">Amount:</span>
';
                $buffer .= $indent . '                                                <span style="font-size:18px;">25000 BITL</span>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span class="pr-5" style="font-size:18px">Token price:</span>
';
                $buffer .= $indent . '                                                <span style="font-size:18px;">$0.05</span>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span class="pr-4" style="font-size:18px">Current Value:</span>
';
                $buffer .= $indent . '                                                <span style="font-size:18px;">$1250</span>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
