...
class __MyTemplates_e6efdf1672886f2ffe7a980c83862b86 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC06dbff986f3a55a85cd49986a74014d($context, $indent, $value);

        return $buffer;
    }

    private function section4c38f60b4faeff6081fa04c365cf8658(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9236575da3450b2d6a79388195e2b672(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section4c38f60b4faeff6081fa04c365cf8658($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function sectionC06dbff986f3a55a85cd49986a74014d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->section9236575da3450b2d6a79388195e2b672($context, $indent, $value);
                $buffer .= $indent . '                        </tbody>
';
                $buffer .= $indent . '                    </table>
';
