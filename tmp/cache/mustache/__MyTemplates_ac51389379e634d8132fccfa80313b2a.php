...
class __MyTemplates_ac51389379e634d8132fccfa80313b2a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section480fe252df29984f858f78aee349599b($context, $indent, $value);
...
';
    ...
    private function section480fe252df29984f858f78aee349599b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        <div class="" style="min-width:20%">
';
