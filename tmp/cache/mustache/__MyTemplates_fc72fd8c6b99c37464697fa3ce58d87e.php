...
class __MyTemplates_fc72fd8c6b99c37464697fa3ce58d87e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA10ba80bc1a7eafff69216401fe96ab0($context, $indent, $value);
...
';
    ...
    private function section18a5ec914981d841032bd20a02749d24(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="col-md-6">
                                             ...
                                             <input type="submit" name="updateTokenInfo" class="btn btn-primary"
                                            value="Update Token Price">
                                        </div>
                                        ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
...
';
                $buffer .= $indent . '                                        
';
                $buffer .= $indent . '                                             <input type="submit" name="updateTokenInfo" class="btn btn-primary"
';
                $buffer .= $indent . '                                            value="Update Token Price">
';
                $buffer .= $indent . '                                        </div>
';
                $context->pop();
...
';
    ...
    private function section64dc7ae6e162e5e9e6958ae6e52efec2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="preview-block">
                                    <form method="post" action="/adminTokenByAllAccount" enctype="multipart/form-data" class="row gy-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" id="tokenAmount" value="{{tokenAmount}}" name="tokenAmount" class="form-control form-control-lg form-control-outlined">
                                                    <label class="form-label-outlined" for="tokenAmount">Token Amount</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="submit" name="updateTokenAmount" class="btn btn-primary"
                                            value="Update Token Amount">
                                        </div>
                                    </form>
                                </div>
                            </div>
...
';
                $buffer .= $indent . '                                                <div class="form-control-wrap">
';
                $buffer .= $indent . '                                                    <input type="text" id="tokenAmount" value="';
                $value = $this->resolveValue($context->find('tokenAmount'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" name="tokenAmount" class="form-control form-control-lg form-control-outlined">
';
                $buffer .= $indent . '                                                    <label class="form-label-outlined" for="tokenAmount">Token Amount</label>
';
                $buffer .= $indent . '                                                </div>
';
                $buffer .= $indent . '                                            </div>
...
';
                $buffer .= $indent . '                                        <div class="col-md-6">
';
                $buffer .= $indent . '                                            <input type="submit" name="updateTokenAmount" class="btn btn-primary"
';
                $buffer .= $indent . '                                            value="Update Token Amount">
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </form>
...
';
    ...
    private function sectionA10ba80bc1a7eafff69216401fe96ab0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section18a5ec914981d841032bd20a02749d24($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
...
';
                ...
                $buffer .= $this->section64dc7ae6e162e5e9e6958ae6e52efec2($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
