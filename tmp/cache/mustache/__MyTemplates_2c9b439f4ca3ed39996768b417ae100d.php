...
class __MyTemplates_2c9b439f4ca3ed39996768b417ae100d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA81afdbc3ca75293619d6abddfa32cdc($context, $indent, $value);
...
';
    ...
    private function sectionA81afdbc3ca75293619d6abddfa32cdc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                      
';
                $buffer .= $indent . '                        <div class="" style="min-width:15%">
';
