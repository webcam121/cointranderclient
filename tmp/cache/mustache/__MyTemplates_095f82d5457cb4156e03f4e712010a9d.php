...
class __MyTemplates_095f82d5457cb4156e03f4e712010a9d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5c572db37129b1aac351ad7e5dd9a736($context, $indent, $value);
...
';
    ...
    private function section5c572db37129b1aac351ad7e5dd9a736(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
