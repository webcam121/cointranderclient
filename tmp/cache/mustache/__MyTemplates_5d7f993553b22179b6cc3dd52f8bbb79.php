...
class __MyTemplates_5d7f993553b22179b6cc3dd52f8bbb79 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section923a75a59cead58f9fed945e39c9a7d1($context, $indent, $value);
...
';
    ...
    private function section923a75a59cead58f9fed945e39c9a7d1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
