...
class __MyTemplates_ac3a2c2c2f5956b77589d94ce443f0b1 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section40854f5a9017157ad448aff8cb2183ce($context, $indent, $value);
...
';
    ...
    private function section40854f5a9017157ad448aff8cb2183ce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
