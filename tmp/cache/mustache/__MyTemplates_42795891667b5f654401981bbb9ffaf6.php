...
class __MyTemplates_42795891667b5f654401981bbb9ffaf6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAd77f4e05f02c4ef7e5cc20688c7662d($context, $indent, $value);

        return $buffer;
    }

    private function sectionAb6ccb073c11d3baaac1e97af5078048(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                                        <div class="card-token mt-1">
                                            ...
                                            <div class="card-token__item">
                                                ...
                                                <span>{{tokenAmount * token_price}}</span>
                                            </div>
                                        </div>
                                        ';
...
';
                $buffer .= $indent . '                                                <span>';
                $value = $this->resolveValue($context->find('tokenAmount * token_price'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</span>
';
                $buffer .= $indent . '                                            </div>
...
';
    ...
    private function sectionAd77f4e05f02c4ef7e5cc20688c7662d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionAb6ccb073c11d3baaac1e97af5078048($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
