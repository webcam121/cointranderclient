...
class __MyTemplates_57f19984eff2602b0908aae09b93a009 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA5700d77903428dafc478ffe6a3cafed($context, $indent, $value);
...
';
    ...
    private function section8a4e03d27080e448b926420b3113f1ab(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                            <tr>
                                                <td>{{tradeType == \'deposit\'? \'\' : tradeNumber}}</td>
                                                <td>{{dateFormatted}}</td>
                                                {{#coinImg}}
                                                    <td style="padding:0">
                                                    <img src="{{coinImg}}" style="width:38px;margin-left:10px;" alt="coinImg"/>
...
';
                $buffer .= $indent . '                                                <td>';
                $value = $this->resolveValue($context->find('tradeType == \'deposit\'? \'\' : tradeNumber'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</td>
';
                $buffer .= $indent . '                                                <td>';
...
';
    ...
    private function section75d79caa8c2446a84e01f20ad9a3d4a3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section8a4e03d27080e448b926420b3113f1ab($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionA5700d77903428dafc478ffe6a3cafed(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->section75d79caa8c2446a84e01f20ad9a3d4a3($context, $indent, $value);
                $buffer .= $indent . '                                        </tbody>
';
                $buffer .= $indent . '                                    </table>
';
