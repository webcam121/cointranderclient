...
class __MyTemplates_3fcf946d274de3d54d9c9db78d903268 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC2a4d3e61d830d8ff6ecdc58f7ab86a2($context, $indent, $value);
...
';
    ...
    private function sectionF855488aac4ab3a6777907f8a4ecf44d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                                        <option value="bl"></option>
';
...
';
    ...
    private function sectionC2a4d3e61d830d8ff6ecdc58f7ab86a2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionF855488aac4ab3a6777907f8a4ecf44d($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
