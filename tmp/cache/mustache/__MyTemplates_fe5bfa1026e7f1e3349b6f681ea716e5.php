...
class __MyTemplates_fe5bfa1026e7f1e3349b6f681ea716e5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB47f1a7f615d38d8eb36607721d140db($context, $indent, $value);
...
';
    ...
    private function sectionB47f1a7f615d38d8eb36607721d140db(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
