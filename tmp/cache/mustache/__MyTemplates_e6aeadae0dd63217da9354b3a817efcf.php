...
class __MyTemplates_e6aeadae0dd63217da9354b3a817efcf extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC7a74c8b2b4cd9ed8ca3703ae5265750($context, $indent, $value);
...
';
    ...
    private function sectionC7a74c8b2b4cd9ed8ca3703ae5265750(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                      ...
                      <div style="display:flex; flex-gap:gap">
                        <div class="" style="min-width:22%">
                            <div class="card">
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="display:flex; flex-gap:gap">
';
                $buffer .= $indent . '                        <div class="" style="min-width:22%">
';
