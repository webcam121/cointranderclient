...
class __MyTemplates_93716221b31169fe77dfbec62e4b3d66 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEe507026df398276a9ad72bb585679ac($context, $indent, $value);
...
';
    ...
    private function sectionEe507026df398276a9ad72bb585679ac(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                            <div class="card layout">
';
                $buffer .= $indent . '                                <div class="card-inner">
';
                $buffer .= $indent . '                                    <div class="card-title-group mb-2">
