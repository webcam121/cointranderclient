...
class __MyTemplates_e95b01938a63c7fb97b02d83877f45f5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFd198bc5b9a863c19b4ff53208f92fd6($context, $indent, $value);
...
';
    ...
    private function sectionFd198bc5b9a863c19b4ff53208f92fd6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        <div style="width:100px">
';
