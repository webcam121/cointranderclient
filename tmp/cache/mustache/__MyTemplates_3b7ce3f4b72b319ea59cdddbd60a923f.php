...
class __MyTemplates_3b7ce3f4b72b319ea59cdddbd60a923f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE12ac2419810dbab8fe6b0b1d18f4e60($context, $indent, $value);
...
';
    ...
    private function sectionE12ac2419810dbab8fe6b0b1d18f4e60(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                    ...
                    <div class="nk-block-head nk-block-head-lg">
                        <div class="nk-block-between-md g-4">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title fw-normal">Setting Token Amount By All Accounts && Setting Token Price</h2>
...
';
                $buffer .= $indent . '                                <h2 class="nk-block-title fw-normal">Setting Token Amount By All Accounts && Setting Token Price</h2>
';
