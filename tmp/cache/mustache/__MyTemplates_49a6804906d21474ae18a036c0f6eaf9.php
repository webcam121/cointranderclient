...
class __MyTemplates_49a6804906d21474ae18a036c0f6eaf9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section277b635d10ca43900652ef06ea073560($context, $indent, $value);
...
';
    ...
    private function section277b635d10ca43900652ef06ea073560(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                      
';
                $buffer .= $indent . '                        <div class="col-xxl-2 col-sm-12">
';
