...
class __MyTemplates_001caf08b6aed486914a95eca297f733 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5ddc960eb4dd3d475b03ad5e70d4b871($context, $indent, $value);

        return $buffer;
    }

    private function sectionE5e3a06681136e70a433dac75df36770(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                                                <span>Tokens:</span>
';
...
';
    ...
    private function section5ddc960eb4dd3d475b03ad5e70d4b871(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionE5e3a06681136e70a433dac75df36770($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
