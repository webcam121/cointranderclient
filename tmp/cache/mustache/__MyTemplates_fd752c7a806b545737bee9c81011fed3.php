...
class __MyTemplates_fd752c7a806b545737bee9c81011fed3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7217041d5142313069858daa4bec7cde($context, $indent, $value);
...
';
    ...
    private function section7217041d5142313069858daa4bec7cde(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="card-content-group mb-2">
                                        <div class="card-content">
                                            <h6 class="title">Amount:</h6> <span>25000BITL</span>
                                        </div>
                                        <div class="card-content">
...
';
                $buffer .= $indent . '                                            <h6 class="title">Amount:</h6> <span>25000BITL</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <div class="card-content">
