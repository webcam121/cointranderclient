...
class __MyTemplates_a84fad997c3d335e4a8da62050c96fd1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA5a603564320c3c5b356c8406688b963($context, $indent, $value);
...
';
    ...
    private function sectionA5a603564320c3c5b356c8406688b963(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <form method="post" action="/adminTokenByAllAccount" enctype="multipart/form-data" class="row gy-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group tokenNumber">
                                                <div class="form-control-wrap">
                                                    <input type="number" id="tokenNumber" name="tokenNumber" class="form-control form-control-lg form-control-outlined" required>
...
';
                $buffer .= $indent . '                                                <div class="form-control-wrap">
';
                $buffer .= $indent . '                                                    <input type="number" id="tokenNumber" name="tokenNumber" class="form-control form-control-lg form-control-outlined" required>
';
