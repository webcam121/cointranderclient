...
class __MyTemplates_b1a42fd154caf85c60c81790736773e2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9c7b819a1a5ca97c0725dce89529d74c($context, $indent, $value);
...
';
    ...
    private function section9c7b819a1a5ca97c0725dce89529d74c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        <div class="" style="width:19%">
';
