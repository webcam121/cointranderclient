...
class __MyTemplates_e46de3bb83ac7821748f6b65fc4ce235 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE47fad73994707ac2b5920466a4c1bdf($context, $indent, $value);
...
';
    ...
    private function sectionE47fad73994707ac2b5920466a4c1bdf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                            <div class="nk-iv-wg3-amount">
';
                $buffer .= $indent . '                                                <div class="number"></div>
';
                $buffer .= $indent . '                                            </div>
';
