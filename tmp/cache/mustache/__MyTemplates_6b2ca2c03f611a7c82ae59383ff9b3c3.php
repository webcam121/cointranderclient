...
class __MyTemplates_6b2ca2c03f611a7c82ae59383ff9b3c3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE67a0f8a37479833c5b131803f0391f3($context, $indent, $value);
...
';
    ...
    private function sectionE46005ab77c0132ce277b401c6f7d229(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section0060cdf65964527e214468b2bddaf596(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionE46005ab77c0132ce277b401c6f7d229($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionE67a0f8a37479833c5b131803f0391f3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->section0060cdf65964527e214468b2bddaf596($context, $indent, $value);
                $buffer .= $indent . '                                        </tbody>
';
                $buffer .= $indent . '                                    </table>
';
