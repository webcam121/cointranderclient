...
class __MyTemplates_dc7338f9d1f1b59cde4974098bba4d66 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://cointrader24.io/terms-of-service/"target="_blank">Terms of Service</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://cointrader24.io/privacy-policy/"target="_blank">Privacy Policy</a>
';
        $buffer .= $indent . '                                  <li class="nav-item">
';
        $buffer .= $indent . '                                <a class="nav-link" href="https://cointrader24.io/faq/"target="_blank">FAQ</a>
';
        $buffer .= $indent . '                            </li>
';
        $buffer .= $indent . '                            </li>
