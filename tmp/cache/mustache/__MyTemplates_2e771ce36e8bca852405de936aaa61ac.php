...
class __MyTemplates_2e771ce36e8bca852405de936aaa61ac extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1c803d48a24b648e1e33c625a34fa0ba($context, $indent, $value);
...
';
    ...
    private function section1c803d48a24b648e1e33c625a34fa0ba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                    <div class="row g-ls">
';
                $buffer .= $indent . '                        
';
