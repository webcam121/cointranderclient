...
class __MyTemplates_33bcc553b85bdfd98cd20e6133cc6c98 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0f96810d301eec2e6a989bad5d48c77f($context, $indent, $value);
...
';
    ...
    private function section0f96810d301eec2e6a989bad5d48c77f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                            ...
                            <div class="account-overview__item" >
                                <div class="account-overview__content">
                                    ...
                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                        <div class="nk-iv-wg3-sub">
                                            <div class="nk-iv-wg3-amount">
                                                <div class="number">{{totalBalance}}/{{initialInvestment}}*100</div>
                                            </div>
