...
class __MyTemplates_c70082763b1591f82818559d66b05950 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9a0cdf582183fde6d90d043a572cb3b3($context, $indent, $value);
...
';
    ...
    private function section9a0cdf582183fde6d90d043a572cb3b3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                ...
                <div class="nk-block">
                    <div class="row g-gs">
                      ...
                      <div style="display:flex;">
                        <div class="col-xxl-2 col-sm-12" style="flex-basis: 200px">
                            <div class="card">
                        ...
                        <div class="col-xxl-2 col-sm-12" style="flex-basic:23%">
                            <div class="card">
                                <div class="nk-ecwg nk-ecwg6">
                                    <div class="card-inner">
                                        <div class="card-title-group">
...
';
                $buffer .= $indent . '                        <div class="col-xxl-2 col-sm-12" style="flex-basis: 200px">
';
...
';
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div class="col-xxl-2 col-sm-12" style="flex-basic:23%">
';
                $buffer .= $indent . '                            <div class="card">
';
                $buffer .= $indent . '                                <div class="nk-ecwg nk-ecwg6">
