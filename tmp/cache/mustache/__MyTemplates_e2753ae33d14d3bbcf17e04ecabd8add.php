...
class __MyTemplates_e2753ae33d14d3bbcf17e04ecabd8add extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF4ea2b220840f33e12fa2539e7cb278e($context, $indent, $value);
...
';
    ...
    private function sectionF4ea2b220840f33e12fa2539e7cb278e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '@media only screen and (min-width:576px) {
';
