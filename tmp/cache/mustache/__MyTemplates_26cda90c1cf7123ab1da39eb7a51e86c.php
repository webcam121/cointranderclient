...
class __MyTemplates_26cda90c1cf7123ab1da39eb7a51e86c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBff8ee85136048e6b6ce0eebf85b5e59($context, $indent, $value);

        return $buffer;
    }

    private function sectionDb4942795d5f67c26b0d2a41b1a924ff(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                                        <div class="card-token mt-1">
                                            ...
                                            <div class="card-token__item">
                                                ...
                                                <span style="font-size: 15px;">{{accountCurrency}}{{token_price}}</span>
                                            </div>
                                            <div class="card-token__item">
                                                <span class="card_item_title">Current Value:</span>
                                                <span style="font-size: 15px;">{{accountCurrency}}{{value}}</span>
                                            </div>
                                        </div>
                                        ';
...
';
    ...
    private function sectionBff8ee85136048e6b6ce0eebf85b5e59(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div class="col-xxl-3 col-sm-12">
';
...
';
                ...
                $buffer .= $this->sectionDb4942795d5f67c26b0d2a41b1a924ff($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
