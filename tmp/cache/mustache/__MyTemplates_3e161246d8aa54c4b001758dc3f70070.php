...
class __MyTemplates_3e161246d8aa54c4b001758dc3f70070 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA5860d23c13013f07bf592ec95d44976($context, $indent, $value);
...
';
    ...
    private function sectionE58e26acd5726e6765d3b8c57a91a83a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section668efa68e5d2aef260d16947a9e42301(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionE58e26acd5726e6765d3b8c57a91a83a($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionA5860d23c13013f07bf592ec95d44976(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->section668efa68e5d2aef260d16947a9e42301($context, $indent, $value);
                $buffer .= $indent . '                                        </tbody>
';
                $buffer .= $indent . '                                    </table>
';
