...
class __MyTemplates_c691f08327bcf7b689646c0e5e829dca extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF1b992922c441cbc98cb8b3813274a3d($context, $indent, $value);
...
';
    ...
    private function sectionE85bc376f8fe916b0b42f07fea91c290(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionF1b992922c441cbc98cb8b3813274a3d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionE85bc376f8fe916b0b42f07fea91c290($context, $indent, $value);
