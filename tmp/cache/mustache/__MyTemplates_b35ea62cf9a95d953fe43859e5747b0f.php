...
class __MyTemplates_b35ea62cf9a95d953fe43859e5747b0f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section74a23a657dccc2f5796ab3d20098f4f1($context, $indent, $value);
...
';
    ...
    private function section74a23a657dccc2f5796ab3d20098f4f1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                            ...
                                            <div class="form-group market">
                                                <div class="form-control-wrap">
                                                    <select id="market" name="market" class="form-select form-control form-control-lg" data-ui="lg" required>
                                                        ...
                                                        <option value="ADA/USD">ADA/USDT</option>
                                                        <option value="DOT/USD">DOT/USDT</option>
...
';
                $buffer .= $indent . '                                                        <option value="ADA/USD">ADA/USDT</option>
';
                $buffer .= $indent . '                                                        <option value="DOT/USD">DOT/USDT</option>
';
                $buffer .= $indent . '                                                        <option value="SOL/USD">SOL/USDT</option>
';
                $buffer .= $indent . '                                                    </select>
';
