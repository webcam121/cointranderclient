...
class __MyTemplates_41042a7e59cde000780abd036081d47c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA21bd0573ae1b9ebd8289eefaa9c3f3b($context, $indent, $value);
...
';
    ...
    private function sectionA21bd0573ae1b9ebd8289eefaa9c3f3b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                                <span style="font-size:15px">Amount:</span>
';
