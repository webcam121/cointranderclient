...
class __MyTemplates_2bc6fb90f3224bf79a21177ec7095765 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC09958faa65fcd108f8e036994a93faa($context, $indent, $value);
...
';
    ...
    private function sectionC09958faa65fcd108f8e036994a93faa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                            ...
                            <div class="card card-preview">
                                <div class="card-inner">
                                    ...
                                    <div class="card-content">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <span class="title-sub">sdfsfs</span>
                                            </div>
                                        </div>
                                    </div>
...
';
                $buffer .= $indent . '                                            <div class="form-control-wrap">
';
                $buffer .= $indent . '                                            <span class="title-sub">sdfsfs</span>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
