...
class __MyTemplates_e8453fcf221cfec60e336ec32fdc7a30 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section343ce9aa1f9a51d97009edecb29b6357($context, $indent, $value);
...
';
    ...
    private function section343ce9aa1f9a51d97009edecb29b6357(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="column-count: 5;column-gap: 10px;">
';
