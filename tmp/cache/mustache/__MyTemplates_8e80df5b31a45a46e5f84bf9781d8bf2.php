...
class __MyTemplates_8e80df5b31a45a46e5f84bf9781d8bf2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5c424880f5cf091343181a0137f6d70d($context, $indent, $value);
...
';
    ...
    private function sectionF9b83445042a51a5ab28f4a1f44ae934(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" name="updateTokenPrice" class="btn btn-primary">
                                                Update Token Price
                                            </button>
                                        </div>
                                        ';
...
';
                $buffer .= $indent . '                                        <div class="col-md-6">
';
                $buffer .= $indent . '                                            <button type="submit" name="updateTokenPrice" class="btn btn-primary">
';
...
';
    ...
    private function section5b13fee8de11cad5c142cb55f8496e31(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                            <div class="card-inner">
                                <div class="preview-block">
                                    <form method="post" action="/adminTokenByAllAccount" enctype="multipart/form-data" class="row gy-3">
                                        ...
                                        <div class="col-md-6">
                                            <input type="submit" name="updateTokenInfoByUser" class="btn btn-primary"
...
';
                $buffer .= $indent . '                                        <div class="col-md-6">
';
                $buffer .= $indent . '                                            <input type="submit" name="updateTokenInfoByUser" class="btn btn-primary"
';
...
';
    ...
    private function section5c424880f5cf091343181a0137f6d70d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionF9b83445042a51a5ab28f4a1f44ae934($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
...
';
                ...
                $buffer .= $this->section5b13fee8de11cad5c142cb55f8496e31($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
