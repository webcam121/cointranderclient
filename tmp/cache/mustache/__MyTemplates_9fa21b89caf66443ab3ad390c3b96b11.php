...
class __MyTemplates_9fa21b89caf66443ab3ad390c3b96b11 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section15bdcdd4f701f7dc2e02628e6a014ca8($context, $indent, $value);
...
';
    ...
    private function section15bdcdd4f701f7dc2e02628e6a014ca8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                      ...
                      <div class="row">
                        <div class="col-xxl-auto col-sm-12">
                            <div class="card">
...
';
                $buffer .= $indent . '                        <div class="col-xxl-auto col-sm-12">
';
