...
class __MyTemplates_625c5bfc626efc1020f5f814095fd6e9 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section88d32e6da305b1adb33d6d15ccd62a58($context, $indent, $value);
...
';
    ...
    private function section88d32e6da305b1adb33d6d15ccd62a58(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
