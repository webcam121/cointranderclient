...
class __MyTemplates_6d64e26cc28c05b553a901b14f261322 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5a9c88af7c0eab434f2697d99999fda9($context, $indent, $value);
...
';
    ...
    private function section5a9c88af7c0eab434f2697d99999fda9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <div class="card-inner">
                                        ...
                                        <div class="card-token mt-1">
                                            <div class="card-token__item">
                                                <span>Amount:</span>
                                                <span>{{tokenInfo->tokenAmount}}</span>
                                            </div>
                                            <div class="card-token__item">
...
';
                $buffer .= $indent . '                                                <span>';
                $value = $this->resolveValue($context->find('tokenInfo->tokenAmount'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</span>
';
                $buffer .= $indent . '                                            </div>
