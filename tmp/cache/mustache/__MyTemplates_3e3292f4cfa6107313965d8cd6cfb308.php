...
class __MyTemplates_3e3292f4cfa6107313965d8cd6cfb308 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section08338fc690ebb718dcd8af448c6f5be4($context, $indent, $value);
...
';
    ...
    private function section08338fc690ebb718dcd8af448c6f5be4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="card-content-group mb-2">
                                        <div class="card-content">
                                            <span class="title">Amount:</span> <span>25000BITL</span>
                                        </div>
                                        <div class="card-content">
...
';
                $buffer .= $indent . '                                            <span class="title">Amount:</span> <span>25000BITL</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <div class="card-content">
