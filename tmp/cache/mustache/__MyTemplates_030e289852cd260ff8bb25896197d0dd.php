...
class __MyTemplates_030e289852cd260ff8bb25896197d0dd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4cdd600d332183de4e1d80e2c0394c0e($context, $indent, $value);
...
';
    ...
    private function section4cdd600d332183de4e1d80e2c0394c0e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '@media only screen and (min-width:700px) {
';
...
';
                $buffer .= $indent . '                            <div class="card h-100 layout">
';
                $buffer .= $indent . '                                <div class="card-inner">
';
                $buffer .= $indent . '                                    <div class="card-title-group mb-2">
