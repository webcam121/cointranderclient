...
class __MyTemplates_c9a67a699740b79296fdafe9a4ba32ea extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0293cdecd1e3d1e3d8b8ff7c5a18c85c($context, $indent, $value);
...
';
    ...
    private function section10207109c11416a8d9aa496f6dc79498(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section0293cdecd1e3d1e3d8b8ff7c5a18c85c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section10207109c11416a8d9aa496f6dc79498($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
