...
class __MyTemplates_bd787816a8f3a1d4dda072db7e6b5263 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section291788f6fedb100d3a768f5e7b0fa518($context, $indent, $value);
...
';
    ...
    private function section13d6eb5bbd743b2b3af048c8353676a6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                            <span>';
                $value = $this->resolveValue($context->find('last_trades_num'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</span>
';
                $buffer .= $indent . '                                        </td>
...
';
    ...
    private function section7c0ef85a97b18eb98b3ec658df7feecd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                         <th class="tb-member-role tb-col-md">
';
                $buffer .= $indent . '                                            <span class="overline-title">LAST TRADE NUMBER</span>
';
                $buffer .= $indent . '                                        </th>
';
...
';
                ...
                $buffer .= $this->section13d6eb5bbd743b2b3af048c8353676a6($context, $indent, $value);
...
';
    ...
    private function section1ed08ca1454bc62896c50a55a6391798(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section291788f6fedb100d3a768f5e7b0fa518(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'isUserList' section
                $value = $context->find('isUserList');
                $buffer .= $this->section7c0ef85a97b18eb98b3ec658df7feecd($context, $indent, $value);
                $buffer .= $indent . '
';
                // 'isTradeList' section
                $value = $context->find('isTradeList');
...
';
                // 'isTrade' section
                $value = $context->find('isTrade');
                $buffer .= $this->section1ed08ca1454bc62896c50a55a6391798($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                    </div>
';
