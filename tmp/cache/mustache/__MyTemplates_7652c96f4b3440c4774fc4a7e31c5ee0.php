...
class __MyTemplates_7652c96f4b3440c4774fc4a7e31c5ee0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section482f0b3fab0a3e5c2b741bea62ce8d65($context, $indent, $value);
...
';
    ...
    private function section482f0b3fab0a3e5c2b741bea62ce8d65(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="card-content-group mb-2">
                                        <div class="card-content">
                                            <h6 class="text">Amount:</h6> <span>25000BITL</span>
                                        </div>
                                        <div class="card-content">
...
';
                $buffer .= $indent . '                                            <h6 class="text">Amount:</h6> <span>25000BITL</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <div class="card-content">
