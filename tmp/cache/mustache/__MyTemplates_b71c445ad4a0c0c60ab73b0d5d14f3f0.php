...
class __MyTemplates_b71c445ad4a0c0c60ab73b0d5d14f3f0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3acccdd4956a50ab8f8f2acc0cf92cd0($context, $indent, $value);
...
';
    ...
    private function section3acccdd4956a50ab8f8f2acc0cf92cd0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-ibx">
                    ...
                    <div class="nk-ibx-body bg-white">
                        ...
                        <div id="inbox" style="overflow:scroll">
                            {{#hasInbox}}
                            <div class="nk-ibx-list" data-simplebar>
                                {{#inboxMessages}}
                                <div class="nk-ibx-item">
                        ...
                        <div id="draft" style="overflow:scroll">
                            {{#hasDraft}}
                            <div class="nk-ibx-list" data-simplebar>
                                {{#draftMessages}}
                                <div class="nk-ibx-item">
                        ...
                        <div id="trash" style="overflow-x:scroll">
                            {{#hasTrash}}
                            <div class="nk-ibx-list" data-simplebar>
                                {{#trashMessages}}
                                <div class="nk-ibx-item">
...
';
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div id="inbox" style="overflow:scroll">
';
                // 'hasInbox' section
...
';
                ...
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div id="draft" style="overflow:scroll">
';
                // 'hasDraft' section
...
';
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div id="trash" style="overflow-x:scroll">
';
                // 'hasTrash' section
