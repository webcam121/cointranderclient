...
class __MyTemplates_8da0251bde355ccbfd1431ec77a1c1a9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section24696df64f45c1cfdc2078846108695f($context, $indent, $value);
...
';
    ...
    private function section24696df64f45c1cfdc2078846108695f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                      ...
                      <div style="column-count: 5;column-gap: 0px;">
                        <div class="">
                            <div class="card">
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="column-count: 5;column-gap: 0px;">
';
