...
class __MyTemplates_47b88e0060c91b42a03c275f99e23973 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAdc17ee409400fe30bdc79bc1ff95fe7($context, $indent, $value);
...
';
    ...
    private function sectionB0c6009df30db689663fa640d9af3ea4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionAdc17ee409400fe30bdc79bc1ff95fe7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionB0c6009df30db689663fa640d9af3ea4($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
