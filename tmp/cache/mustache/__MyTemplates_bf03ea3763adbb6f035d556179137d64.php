...
class __MyTemplates_bf03ea3763adbb6f035d556179137d64 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8f1b5b9a5d25c2f0f81e4ae2530a463e($context, $indent, $value);
...
';
    ...
    private function section4d47fe9defe39583ab0e00e81c5f2ccc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '">';
                $value = $this->resolveValue($context->find('senderName'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</div>
';
                $buffer .= $indent . '                                            </div>
...
';
    ...
    private function sectionA4dbd57fd146e66f9247de7986801a59(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section766111e18ee5507c28cbd59bd558e855(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section4d47fe9defe39583ab0e00e81c5f2ccc($context, $indent, $value);
                $buffer .= $indent . '                            </div>
';
...
';
                // 'inboxMessages' section
                $value = $context->find('inboxMessages');
                $buffer .= $this->sectionA4dbd57fd146e66f9247de7986801a59($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
...
';
    ...
    private function section53d34aa0c994a67d518a20db6a5f185f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $value = $this->resolveValue($context->find('receiverName'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</span>
';
                $buffer .= $indent . '                                                        </div>
...
';
    ...
    private function section8dbdc7eae7d001ac453fec2fdba7d533(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'draftMessages' section
                $value = $context->find('draftMessages');
                $buffer .= $this->section53d34aa0c994a67d518a20db6a5f185f($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
...
';
    ...
    private function section31edc34efbfb0df8ed7d6703b88d3c80(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionEa71807b4df9439f1cbdcc9571ce22c5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section8f1b5b9a5d25c2f0f81e4ae2530a463e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-ibx">
                    ...
                    <div class="nk-ibx-body bg-white">
                        ...
                        <div id="sent" style="overflow: scroll;">
                            {{#hasSent}}
                            <div class="" data-simplebar>
                                {{#sentMessages}}
                                <div class="nk-ibx-item">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div style="margin-top:80px">
';
                $buffer .= $indent . '    <style>
';
...
';
                ...
                $buffer .= $this->section766111e18ee5507c28cbd59bd558e855($context, $indent, $value);
...
';
                ...
                $buffer .= $this->section8dbdc7eae7d001ac453fec2fdba7d533($context, $indent, $value);
...
';
                ...
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div id="sent" style="overflow: scroll;">
';
                // 'hasSent' section
                $value = $context->find('hasSent');
                $buffer .= $this->section31edc34efbfb0df8ed7d6703b88d3c80($context, $indent, $value);
...
';
                ...
                $buffer .= $this->sectionEa71807b4df9439f1cbdcc9571ce22c5($context, $indent, $value);
