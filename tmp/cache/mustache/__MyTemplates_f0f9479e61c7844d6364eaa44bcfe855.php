...
class __MyTemplates_f0f9479e61c7844d6364eaa44bcfe855 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF063b83a20b402e66673ea18c6588d10($context, $indent, $value);
...
';
    ...
    private function sectionF063b83a20b402e66673ea18c6588d10(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-ibx">
                    ...
                    <div class="nk-ibx-body bg-white">
                        ...
                        <div id="trash" style="overflow:scroll">
                            {{#hasTrash}}
                            <div class="nk-ibx-list" data-simplebar>
                                {{#trashMessages}}
                                <div class="nk-ibx-item">
...
';
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div id="trash" style="overflow:scroll">
';
                // 'hasTrash' section
