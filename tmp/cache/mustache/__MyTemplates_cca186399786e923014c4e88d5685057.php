...
class __MyTemplates_cca186399786e923014c4e88d5685057 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1a09dbdb721fe0f68859d3490733de80($context, $indent, $value);
...
';
    ...
    private function section1a09dbdb721fe0f68859d3490733de80(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                        ...
                        <div class="col-xxl-2.5 col-sm-12" style="flex-basic:23%">
                            <div class="card">
                        ...
                        <div class="col-xxl-12 col-sm-12" style="flex-basic:23%">
                            <div class="card">
                                <div class="nk-ecwg nk-ecwg6">
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                    ...
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            <div class="token_logo">
                                                <img src="../assets/images/BITL_LOGO.png" alt="BITL LOGO"/> 
                                            </div>
                                            <div class="card-title">
...
';
                $buffer .= $indent . '                      
';
                $buffer .= $indent . '                        <div class="col-xxl-2.5 col-sm-12" style="flex-basic:23%">
';
...
';
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div class="col-xxl-12 col-sm-12" style="flex-basic:23%">
';
                $buffer .= $indent . '                            <div class="card">
';
                $buffer .= $indent . '                                <div class="nk-ecwg nk-ecwg6">
...
';
                $buffer .= $indent . '                                        <div class="card-title-group">
';
                $buffer .= $indent . '                                            <div class="token_logo">
';
                $buffer .= $indent . '                                                <img src="../assets/images/BITL_LOGO.png" alt="BITL LOGO"/> 
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                            <div class="card-title">
...
';
                $buffer .= $indent . '                                                <span>Amount:</span>
';
