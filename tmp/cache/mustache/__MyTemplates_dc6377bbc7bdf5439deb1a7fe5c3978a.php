...
class __MyTemplates_dc6377bbc7bdf5439deb1a7fe5c3978a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1cf80c1b923929309dcb8a1b28468ea9($context, $indent, $value);
...
';
    ...
    private function section1cf80c1b923929309dcb8a1b28468ea9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
