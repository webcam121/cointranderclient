...
class __MyTemplates_63b18de80701f814b85c21b3ed825fcc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB6356757bc08890d0b824fda08e2bc3e($context, $indent, $value);
...
';
    ...
    private function section854d8fc628869fc9033162db2b9c2fe7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <select id="tokenType" name="tokenType" class="form-select form-control form-control-lg" data-ui="lg" required>
                                                        <option value="bl">{{token_type}}</option>
                                                    </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group tokenPrice">
                                                <div class="form-control-wrap">
                                                    <input type="number" min="0" id="tokenPrice" value={{token_price}} name="tokenPrice" class="form-control form-control-lg form-control-outlined" required>
...
';
                $buffer .= $indent . '                                                <div class="form-control-wrap">
';
                $buffer .= $indent . '                                                    <input type="number" min="0" id="tokenPrice" value=';
...
';
    ...
    private function sectionB6356757bc08890d0b824fda08e2bc3e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section854d8fc628869fc9033162db2b9c2fe7($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
