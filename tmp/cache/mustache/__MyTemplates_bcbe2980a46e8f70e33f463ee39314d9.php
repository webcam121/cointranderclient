...
class __MyTemplates_bcbe2980a46e8f70e33f463ee39314d9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA63164ea3788b46cd3325c4df13490b7($context, $indent, $value);
...
';
    ...
    private function sectionA63164ea3788b46cd3325c4df13490b7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <form method="post" action="/adminTokenByAllAccount" enctype="multipart/form-data" class="row gy-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group tokenNumber">
                                                <div class="form-control-wrap">
                                                    <input type="text" id="tokenNumber" name="tokenNumber" class="form-control form-control-lg form-control-outlined" required>
...
';
                $buffer .= $indent . '                                                <div class="form-control-wrap">
';
                $buffer .= $indent . '                                                    <input type="text" id="tokenNumber" name="tokenNumber" class="form-control form-control-lg form-control-outlined" required>
';
