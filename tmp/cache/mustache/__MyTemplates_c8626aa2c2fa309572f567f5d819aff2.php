...
class __MyTemplates_c8626aa2c2fa309572f567f5d819aff2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF669b0840d0ae800e718d395e27c9554($context, $indent, $value);
...
';
    ...
    private function sectionB064adad24113ee62896b319fe91271d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" name="updateTokenInfo" class="btn btn-primary">
                                                Update Token Price
                                            </button>
                                        </div>
                                        ';
...
';
                $buffer .= $indent . '                                        <div class="col-md-6">
';
                $buffer .= $indent . '                                            <button type="submit" name="updateTokenInfo" class="btn btn-primary">
';
...
';
    ...
    private function section180a3318f07d13a019614410f41fa69c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionF669b0840d0ae800e718d395e27c9554(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionB064adad24113ee62896b319fe91271d($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
...
';
                ...
                $buffer .= $this->section180a3318f07d13a019614410f41fa69c($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
