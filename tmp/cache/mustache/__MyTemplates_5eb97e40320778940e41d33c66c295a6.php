...
class __MyTemplates_5eb97e40320778940e41d33c66c295a6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8242833802a0bb58a2f7bf99d5e5cf91($context, $indent, $value);
...
';
    ...
    private function sectionFb13d6a965f8c1318ea4dc9df35b8f05(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section8242833802a0bb58a2f7bf99d5e5cf91(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionFb13d6a965f8c1318ea4dc9df35b8f05($context, $indent, $value);
