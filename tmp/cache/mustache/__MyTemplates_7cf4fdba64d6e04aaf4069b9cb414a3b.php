...
class __MyTemplates_7cf4fdba64d6e04aaf4069b9cb414a3b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section90b35a46b328485e9cc7a3d83204c6ac($context, $indent, $value);
...
';
    ...
    private function section7f6e9f29e383a17a4695a85074a9e991(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section90b35a46b328485e9cc7a3d83204c6ac(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section7f6e9f29e383a17a4695a85074a9e991($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
