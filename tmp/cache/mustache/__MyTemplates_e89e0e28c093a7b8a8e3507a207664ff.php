...
class __MyTemplates_e89e0e28c093a7b8a8e3507a207664ff extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section46bae27ea570e2601171e5b32cab1e69($context, $indent, $value);
...
';
    ...
    private function section01b442b933c068e86f4628f0d05e4bbc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section46bae27ea570e2601171e5b32cab1e69(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section01b442b933c068e86f4628f0d05e4bbc($context, $indent, $value);
