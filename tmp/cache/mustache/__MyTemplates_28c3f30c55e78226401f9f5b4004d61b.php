...
class __MyTemplates_28c3f30c55e78226401f9f5b4004d61b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section87b6391f519a5c5c72edee9e982773ab($context, $indent, $value);
...
';
    ...
    private function section87b6391f519a5c5c72edee9e982773ab(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="display:flex; flex-grow:0">
';
