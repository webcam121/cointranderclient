...
class __MyTemplates_1e90a0d61765fd26ab57e39e439141e4 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9e4ca14a02b78fe0cff2d51709ebcfb0($context, $indent, $value);
...
';
    ...
    private function section9e4ca14a02b78fe0cff2d51709ebcfb0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        <div class="width:23%">
';
