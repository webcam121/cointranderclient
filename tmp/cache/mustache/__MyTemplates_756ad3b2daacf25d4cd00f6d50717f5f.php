...
class __MyTemplates_756ad3b2daacf25d4cd00f6d50717f5f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section90de0927b0f33718f4474a36b665a216($context, $indent, $value);
...
';
    ...
    private function section90de0927b0f33718f4474a36b665a216(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                            ...
                            <form class="card card-bordered" action="/register" method="post">
                                ...
                                <div class="nk-kycfm">
                                    ...
                                    <div class="nk-kycfm-head">
                                        ...
                                        <div class="nk-kycfm-title">
                                            <h5 class="title">Your Address Details</h5>
                                    ...
                                    <div class="nk-kycfm-head">
                                        ...
                                        <div class="nk-kycfm-title">
                                            <h5 class="title">Your Account Type</h5>
                                            <p class="sub-title">Choose the account you would like to open</p>
                                        </div>
                                    </div>
                                    <div class="nk-kycfm-content">
                                        <div class="row g-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-group">
                                                        <select class="form-select" id="accountType" name="accountType" data-ui="lg" required>
                                                            <option value="tc">Trial</option>
                                                            <option value="gd">Digital Pro</option>
                                                            <option value="gd+">Digital Plus</option>
                                                            <option value="pt">Professional</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-group">
                                                        <input type="text" id="initialInvestment" min="250" placeholder="Minimum Investment is 250" class="form-control form-control-lg" required>
                                    ...
                                    <div class="nk-kycfm-footer">
                                        <div class="form-group">
                                            <div class="custom-control custom-control-xs custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="tc-agree">I Have Read The <a href="/termsPolicy">Terms & Policy</a></label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-control-xs custom-checkbox">
                                        ...
                                        <div class="nk-kycfm-action pt-2">
                                            <button type="submit" class="btn btn-lg btn-primary pl-5 pr-5">Create an Account</button>
    ...
    <div class="nk-footer nk-footer-fluid bg-lighter">
        <div class="container-xl wide-lg">
            <div class="nk-footer-wrap">
                <div class="nk-footer-copyright"> &copy; 2022 Bitlafa Group.</div>
...
$(document).ready(function() {
    ...
    $(\'#accountType\').on(\'change\', function() {
        ...
        switch(accountType) {
            case \'tc\':
                initialInvestment.min = 250;
                initialInvestment.placeholder = "Minimum Investment is 250";
                $(\'.kycAmlDocuments\').hide();
                break;
            case \'gd\':
...
';
                $buffer .= $indent . '                                        <div class="nk-kycfm-title">
';
                $buffer .= $indent . '                                            <h5 class="title">Your Address Details</h5>
';
...
';
                $buffer .= $indent . '                                        <div class="nk-kycfm-title">
';
                $buffer .= $indent . '                                            <h5 class="title">Your Account Type</h5>
';
                $buffer .= $indent . '                                            <p class="sub-title">Choose the account you would like to open</p>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </div>
...
';
                $buffer .= $indent . '                                                    <div class="form-label-group">
';
                $buffer .= $indent . '                                                        <label class="form-label">Account Type <span class="text-danger">*</span></label>
';
                $buffer .= $indent . '                                                    </div>
';
                $buffer .= $indent . '                                                    <div class="form-control-group">
...
';
                $buffer .= $indent . '                                                            <option value="tc">Trial</option>
';
                $buffer .= $indent . '                                                            <option value="gd">Digital Pro</option>
';
                $buffer .= $indent . '                                                            <option value="gd+">Digital Plus</option>
';
                $buffer .= $indent . '                                                            <option value="pt">Professional</option>
';
                $buffer .= $indent . '                                                          
';
                $buffer .= $indent . '                                                        </select>
...
';
                $buffer .= $indent . '                                                    <div class="form-control-group">
';
                $buffer .= $indent . '                                                        <input type="text" id="initialInvestment" min="250" placeholder="Minimum Investment is 250" class="form-control form-control-lg" required>
';
...
';
                $buffer .= $indent . '                                                    <div class="form-label-group">
';
                $buffer .= $indent . '                                                        <label class="form-label">Promotion Code</label>
';
                $buffer .= $indent . '                                                    </div>
';
                $buffer .= $indent . '                                                    <div class="form-control-group">
...
';
                $buffer .= $indent . '                                                <label class="custom-control-label" for="tc-agree">I Have Read The <a href="/termsPolicy">Terms & Policy</a></label>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
...
';
                $buffer .= $indent . '                                            <button type="submit" class="btn btn-lg btn-primary pl-5 pr-5">Create an Account</button>
';
...
';
                $buffer .= $indent . '                <div class="nk-footer-copyright"> &copy; 2022 Bitlafa Group.</div>
';
...
';
                $buffer .= $indent . '                            <a class="nav-link" href="#">Terms & Policy</a>
';
                $buffer .= $indent . '                        </li>
';
                $buffer .= $indent . '                        <li class="nav-item">
';
                $buffer .= $indent . '                            <a class="nav-link" href="#">FAQ</a>
';
                $buffer .= $indent . '                        </li>
';
                $buffer .= $indent . '                    </ul>
...
';
                $buffer .= $indent . '                initialInvestment.min = 250;
';
                $buffer .= $indent . '                initialInvestment.placeholder = "Minimum Investment is 250";
';
                $buffer .= $indent . '                $(\'.kycAmlDocuments\').hide();
';
                $buffer .= $indent . '                break;
