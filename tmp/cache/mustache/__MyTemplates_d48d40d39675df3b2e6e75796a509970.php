...
class __MyTemplates_d48d40d39675df3b2e6e75796a509970 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section12a238e2f732b326689592cd7fdabda9($context, $indent, $value);
...
';
    ...
    private function section12a238e2f732b326689592cd7fdabda9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
