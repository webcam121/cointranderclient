...
class __MyTemplates_0ddc34435e4b1a91c4a979e755fe36fe extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9cf75cca1dd9c2c4ef9d31f59ae06b53($context, $indent, $value);
...
';
    ...
    private function section9cf75cca1dd9c2c4ef9d31f59ae06b53(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="card-content-group mb-2">
                                        <div class="card-content">
                                            <div class="amount">Amount:</div> <span>25000BITL</span>
                                        </div>
                                        <div class="card-content">
...
';
                $buffer .= $indent . '                                            <div class="amount">Amount:</div> <span>25000BITL</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <div class="card-content">
