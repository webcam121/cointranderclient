...
class __MyTemplates_c61c04e00a47d5bf1cc76e0c3b2c5d72 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB840704975f3e3ae2fd563f306d371a5($context, $indent, $value);
...
';
    ...
    private function section961baf3e871b03523e6376ea8d3ceeec(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                            <span>';
                $value = $this->resolveValue($context->find('tokenId'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</span>
';
                $buffer .= $indent . '                                        </td>
...
';
    ...
    private function section14717a37694abea2414731253c76266b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section961baf3e871b03523e6376ea8d3ceeec($context, $indent, $value);
...
';
    ...
    private function sectionB840704975f3e3ae2fd563f306d371a5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section14717a37694abea2414731253c76266b($context, $indent, $value);
                $buffer .= $indent . '
';
                // 'isTradeList' section
