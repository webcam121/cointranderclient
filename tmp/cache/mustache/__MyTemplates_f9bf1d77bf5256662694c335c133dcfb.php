...
class __MyTemplates_f9bf1d77bf5256662694c335c133dcfb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section47ec8462b6c6b8b000fc5afa802dac1c($context, $indent, $value);
...
';
    ...
    private function section47ec8462b6c6b8b000fc5afa802dac1c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        
';
                $buffer .= $indent . '                      <div style="display:flex; flex-grow:1">
';
