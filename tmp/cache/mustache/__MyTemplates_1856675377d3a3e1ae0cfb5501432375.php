...
class __MyTemplates_1856675377d3a3e1ae0cfb5501432375 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8b9077e4512a028087a7dd8e290a38f8($context, $indent, $value);
...
';
    ...
    private function section8b9077e4512a028087a7dd8e290a38f8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
