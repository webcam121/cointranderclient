...
class __MyTemplates_17a8d328f06a0dda573070c4afdb3ec9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section78aa8cb7c63b6d2682df2c62a033d4c1($context, $indent, $value);
...
';
    ...
    private function section71e3fa612b80adc50977302e1d2c6bb9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section78aa8cb7c63b6d2682df2c62a033d4c1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section71e3fa612b80adc50977302e1d2c6bb9($context, $indent, $value);
