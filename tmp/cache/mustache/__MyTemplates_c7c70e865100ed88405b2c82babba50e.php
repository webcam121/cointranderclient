...
class __MyTemplates_c7c70e865100ed88405b2c82babba50e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section96ec9eced0e232cb2c60c79de9686865($context, $indent, $value);

        return $buffer;
    }

    private function sectionBdfd9f742f127ca13cbd72b419eb1947(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section96ec9eced0e232cb2c60c79de9686865(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionBdfd9f742f127ca13cbd72b419eb1947($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
