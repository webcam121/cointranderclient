...
class __MyTemplates_98ae39ba76ba226ba9835aaaa47b03ac extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section86d8e7380164aa2f999803493fdc3c10($context, $indent, $value);
...
';
    ...
    private function section86d8e7380164aa2f999803493fdc3c10(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="card-content mb-5">
                                        <div class="card-token">
                                            ...
                                            <div class="card-token-item">
                                                <span class="pr-3" style="font-size:18px">Current Value:</span>
...
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span class="pr-3" style="font-size:18px">Current Value:</span>
';
