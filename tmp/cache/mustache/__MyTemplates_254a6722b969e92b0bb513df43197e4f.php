...
class __MyTemplates_254a6722b969e92b0bb513df43197e4f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6adb1add8373129e1479e03e590ed5e4($context, $indent, $value);
...
';
    ...
    private function section6adb1add8373129e1479e03e590ed5e4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                            ...
                            <div class="alert alert-pro alert-primary">
                                <div class="alert-text">
                                    <div class="tradingview-widget-container">
                                        ...
                                        "symbols": [
                                        {
                                            "proName": "BITSTAMP:XRPUSDT",
                                            "title": "XRP/USDT"
                                        },
                                        {
                                            "proName": "BITSTAMP:LTCUSDT",
                                            "title": "LTC/USDT"
                                        },
                                        {
...
';
                $buffer .= $indent . '                                        {
';
                $buffer .= $indent . '                                            "proName": "BITSTAMP:XRPUSDT",
';
...
';
                $buffer .= $indent . '                                        {
';
                $buffer .= $indent . '                                            "proName": "BITSTAMP:LTCUSDT",
';
