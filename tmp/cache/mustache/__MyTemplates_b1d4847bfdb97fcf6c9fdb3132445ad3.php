...
class __MyTemplates_b1d4847bfdb97fcf6c9fdb3132445ad3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2242f29058bf8731145c59487f019b48($context, $indent, $value);
...
';
    ...
    private function section1d4c9064d255a22f2a0c27f6bc536ce8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                            value="Update Token">
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </form>
...
';
    ...
    private function section2242f29058bf8731145c59487f019b48(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section1d4c9064d255a22f2a0c27f6bc536ce8($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
