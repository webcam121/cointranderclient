...
class __MyTemplates_44a6c9bcd29612783020b6ce0e289164 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                                    <p>Cryptocurrency works harder and smarter with <br>The CoinTrader24 Group.</p>
';
        $buffer .= $indent . '                                </div>
';
        $buffer .= $indent . '                            </div>
