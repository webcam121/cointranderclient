...
class __MyTemplates_5ef1540bdfbe2728b6a4ce6a0fc2daa7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2115dc24db5fb2de86819e01385478d9($context, $indent, $value);
...
';
    ...
    private function section2115dc24db5fb2de86819e01385478d9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
