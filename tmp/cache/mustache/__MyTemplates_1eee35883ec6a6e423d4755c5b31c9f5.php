...
class __MyTemplates_1eee35883ec6a6e423d4755c5b31c9f5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section26839c3e9c373c9b19b8178a7bc79240($context, $indent, $value);

        return $buffer;
    }

    private function sectionE9dc54ea3c6d49c1deb05bc044162ed9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                                                <span>';
                $value = $this->resolveValue($context->find('amount'), $context, $indent);
...
';
    ...
    private function section26839c3e9c373c9b19b8178a7bc79240(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionE9dc54ea3c6d49c1deb05bc044162ed9($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
