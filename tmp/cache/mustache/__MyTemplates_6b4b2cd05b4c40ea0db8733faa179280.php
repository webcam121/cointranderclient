...
class __MyTemplates_6b4b2cd05b4c40ea0db8733faa179280 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE227102d454dcd466de37064a7fd884a($context, $indent, $value);
...
';
    ...
    private function sectionE227102d454dcd466de37064a7fd884a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
