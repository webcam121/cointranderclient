...
class __MyTemplates_806dda841adb1cc152d1a988bbc40d6f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8a055f44278876394327d4cdabbf034e($context, $indent, $value);
...
';
    ...
    private function section8a055f44278876394327d4cdabbf034e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                              <div class="col-xxl-4 col-sm-6">
';
                $buffer .= $indent . '                            <div class="card">
';
                $buffer .= $indent . '                                <div class="nk-ecwg nk-ecwg6">
...
';
                $buffer .= $indent . '                                            <div class="card-title">
';
                $buffer .= $indent . '                                                <h6 class="title">ICO Tokens</h6>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
