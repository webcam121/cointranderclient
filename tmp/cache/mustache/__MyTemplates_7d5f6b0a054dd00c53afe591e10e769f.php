...
class __MyTemplates_7d5f6b0a054dd00c53afe591e10e769f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB38d4fcb58e4fd0768da0906b7e2348b($context, $indent, $value);
...
';
    ...
    private function sectionB38d4fcb58e4fd0768da0906b7e2348b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
