...
class __MyTemplates_5416344895875493cc1ce741294b4ac5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0da66d8b33197d1b20cce1bfdec2b311($context, $indent, $value);

        return $buffer;
    }

    private function section0da66d8b33197d1b20cce1bfdec2b311(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body row">
                <div class="buysell wide-xs m-auto" style="width:100%">
                                ...
                                <form action="#" class="buysell-form">
                                    <div class="buysell-field form-group">
                                        <div class="form-label-group">
                                            <label class="form-label">Choose the algorithm</label>
                                        </div>
                                        <div class="dropdown buysell-cc-dropdown">
                                            <a href="#" class="buysell-cc-choosen">
                                                <div class="coin-item coin-btc" style="padding: 5px 15px;">
                                    ...
                                    <div class="buysell-field form-action">
                                        <a href="#" id="continueDeposit" class="btn btn-lg btn-block btn-primary"  data-toggle="modal" data-target="#depositModal">Upgrade Account</a>
                                    </div>
                                </form>
                            </div>
...
$(document).ready(function() {
     $("#algorthumType").html(\'<img src="./assets/images/banner/Apollo.svg" style="width:60px" alt="algorthum Image" />\');
     $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="1000" placeholder="Min Amount is 1000$" >\');
    $("#tokenType").change(function(){
    if($(this).val() == \'gd\'){
        $("#algorthumType").html(\'<img src="./assets/images/banner/Apollo.svg" style="width:60px" alt="algorthum Image" />\');
        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="1000" placeholder="Min Amount is 1000$" >\');
    }else if($(this).val() == \'gd+\') {
        $("#algorthumType").html(\'<img src="./assets/images/banner/Thor.svg" style="width:60px" alt="algorthum Image" />\');
        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="5000" placeholder="Min Amount is 5000$" >\');
    }else if($(this).val() == \'pt\') {
        $("#algorthumType").html(\'<img src="./assets/images/banner/Odin.svg" style="width:60px" alt="algorthum Image" />\');
        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="20000" placeholder="Min Amount is 20000$" >\');
    }else if($(this).val() == \'zu\') {
        $("#algorthumType").html(\'<img src="./assets/images/banner/Zeus.svg" style="width:60px" alt="algorthum Image" />\');
        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="50000" placeholder="Min Amount is 50000$" >\');
    }else if($(this).val() == \'st\') {
        $("#algorthumType").html(\'<img src="./assets/images/banner/Staking.svg" style="width:60px" alt="algorthum Image" />\');
        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="20000" placeholder="Min Amount is 20000$" >\');
    }
...
';
                $buffer .= $indent . '                <div class="buysell wide-xs m-auto" style="width:100%">
';
                $buffer .= $indent . '                    
';
...
';
                $buffer .= $indent . '                                            <label class="form-label">Choose the algorithm</label>
';
                $buffer .= $indent . '                                        </div>
';
...
';
                $buffer .= $indent . '                                                <div class="coin-item coin-btc" style="padding: 5px 15px;">
';
...
';
                $buffer .= $indent . '                                        <a href="#" id="continueDeposit" class="btn btn-lg btn-block btn-primary"  data-toggle="modal" data-target="#depositModal">Upgrade Account</a>
';
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </form>
...
';
                $buffer .= $indent . '     $("#algorthumType").html(\'<img src="./assets/images/banner/Apollo.svg" style="width:60px" alt="algorthum Image" />\');
';
                $buffer .= $indent . '     $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="1000" placeholder="Min Amount is 1000$" >\');
';
...
';
                $buffer .= $indent . '        $("#algorthumType").html(\'<img src="./assets/images/banner/Thor.svg" style="width:60px" alt="algorthum Image" />\');
';
                $buffer .= $indent . '        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="5000" placeholder="Min Amount is 5000$" >\');
';
                $buffer .= $indent . '    }else if($(this).val() == \'pt\') {
';
                $buffer .= $indent . '        $("#algorthumType").html(\'<img src="./assets/images/banner/Odin.svg" style="width:60px" alt="algorthum Image" />\');
';
                $buffer .= $indent . '        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="20000" placeholder="Min Amount is 20000$" >\');
';
                $buffer .= $indent . '    }else if($(this).val() == \'zu\') {
';
                $buffer .= $indent . '        $("#algorthumType").html(\'<img src="./assets/images/banner/Zeus.svg" style="width:60px" alt="algorthum Image" />\');
';
                $buffer .= $indent . '        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="50000" placeholder="Min Amount is 50000$" >\');
';
                $buffer .= $indent . '    }else if($(this).val() == \'st\') {
';
                $buffer .= $indent . '        $("#algorthumType").html(\'<img src="./assets/images/banner/Staking.svg" style="width:60px" alt="algorthum Image" />\');
';
                $buffer .= $indent . '        $("#textAmount").html(\'<input type="text" class="form-control form-control-lg form-control-number" id="depositAmount" autocomplete="off" name="depositAmount" min="20000" placeholder="Min Amount is 20000$" >\');
';
                $buffer .= $indent . '    }
