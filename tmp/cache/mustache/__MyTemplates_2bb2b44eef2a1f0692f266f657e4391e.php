...
class __MyTemplates_2bb2b44eef2a1f0692f266f657e4391e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section49ca05c00bb7e283f7048fc0da39410f($context, $indent, $value);
...
';
    ...
    private function section49ca05c00bb7e283f7048fc0da39410f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="account-overview__content">
                                    ...
                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                        <div class="nk-iv-wg3-sub">
                                            ...
                                            <div class="nk-iv-wg3-subtitle">Current Balance</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="account-overview__content">
                                    ...
                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                        <div class="nk-iv-wg3-sub">
                                            ...
                                            <div class="nk-iv-wg3-subtitle">Percentage Return</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                            <div class="nk-iv-wg3-subtitle">Current Balance</div>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </div>
...
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                            <div class="nk-iv-wg3-subtitle">Percentage Return</div>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </div>
