...
class __MyTemplates_f85902d1fb0712d1589d00ab63767f49 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB49a7923cbd06600e3ced276a97862d7($context, $indent, $value);
...
';
    ...
    private function sectionB49a7923cbd06600e3ced276a97862d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <div class="card-content mb-5">
                                        <div class="card-token">
                                            <div class="card-token-item">
                                                <span  style="font-size:18px; min-width:300px;">Amount:</span>
                                                <span style="font-size:18px;">25000 BITL</span>
                                            </div>
                                            <div class="card-token-item">
                                                <span style="font-size:18px">Token price:</span>
                                                <span style="font-size:18px;">$0.05</span>
                                            </div>
                                            <div class="card-token-item">
                                                <span style="font-size:18px">Current Value:</span>
...
';
                $buffer .= $indent . '                                                <span  style="font-size:18px; min-width:300px;">Amount:</span>
';
...
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span style="font-size:18px">Token price:</span>
';
...
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span style="font-size:18px">Current Value:</span>
';
