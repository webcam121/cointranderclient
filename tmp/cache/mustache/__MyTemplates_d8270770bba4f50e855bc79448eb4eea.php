...
class __MyTemplates_d8270770bba4f50e855bc79448eb4eea extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section749d55480660124ddab290320c51a1eb($context, $indent, $value);
...
';
    ...
    private function section749d55480660124ddab290320c51a1eb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <table class="datatable-init table" style="min-height: 290px;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 20%">Profit/Loss</th>
...
';
                $buffer .= $indent . '                                                <th style="width: 20%">Position</th>
';
                $buffer .= $indent . '                                                <th style="width: 20%">Profit/Loss</th>
';
                $buffer .= $indent . '                                                
';
                $buffer .= $indent . '                                            </tr>
