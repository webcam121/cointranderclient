...
class __MyTemplates_50b218de737a0b74ba0026f7b5c16dfc extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDf1c2148618e2654e26e37ff028c9e61($context, $indent, $value);
...
';
    ...
    private function sectionDf1c2148618e2654e26e37ff028c9e61(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                    ...
                    <div class="nk-block-head nk-block-head-lg">
                        <div class="nk-block-between-md g-4">
                            <div class="nk-block-head-content">
                                <h2 class="nk-tle fw-normal"><a href="/agentusers">Agent Account</a>/Client Accounts</h2>
...
';
                $buffer .= $indent . '                                <h2 class="nk-tle fw-normal"><a href="/agentusers">Agent Account</a>/Client Accounts</h2>
';
