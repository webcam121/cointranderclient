...
class __MyTemplates_a04863c5cc199559f72eb61a8fb016f4 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<style>
';
        $buffer .= $indent . '@media only screen and (min-width:1200px){
';
        $buffer .= $indent . '    .account-overview {
';
        $buffer .= $indent . '        display:flex;
';
        $buffer .= $indent . '        justify-content:space-beetween;
';
        $buffer .= $indent . '        width:100%;
';
        $buffer .= $indent . '        gap:5px;
';
        $buffer .= $indent . '    }
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    .account-overview__content {
';
        $buffer .= $indent . '        display: flex;
';
...
';
        $buffer .= $indent . '    }
';
        $buffer .= $indent . '    .account-overview__item {
';
        $buffer .= $indent . '        width: 25%
';
        $buffer .= $indent . '    }
';
        $buffer .= $indent . '}
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '@media only screen and (min-width:768px) {
';
        $buffer .= $indent . '    .account-overview {
';
        $buffer .= $indent . '        display:flex;
...
';
        ...
        $buffer .= $this->section5981c53f326ca271cd0e2dede5ad3285($context, $indent, $value);

        return $buffer;
    }

    private function section598a8d83baa93dbd8ef4b7538c95c9c3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEcc5287c08e533aeee75445753e0bfc2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'tradeNumber' section
                $value = $context->find('tradeNumber');
                $buffer .= $this->section598a8d83baa93dbd8ef4b7538c95c9c3($context, $indent, $value);
                // 'tradeNumber' inverted section
                $value = $context->find('tradeNumber');
                if (empty($value)) {
...
';
    ...
    private function sectionD3958046d31cb828bcf9fd73bbedf2d5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionEcc5287c08e533aeee75445753e0bfc2($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function section5981c53f326ca271cd0e2dede5ad3285(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
<div class="nk-content" style="padding-top:70px;">
                ...
                <div class="card-inner-group">
                        ...
                        <div class="account-overview">
                            <div class="account-overview__item" >
                                <div class="account-overview__content">
                                    <div class="nk-iv-wg3-title">Initial Investment</div>
                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                        
                                        <div class="nk-iv-wg3-sub">
                                            <div class="nk-iv-wg3-amount">
                                                <div class="number">{{currency}}{{initialInvestment}}</div>
                                            </div>
                            ...
                            <div class="account-overview__item" >
                                <div class="account-overview__content">
                                    <div class="nk-iv-wg3-title">Current Balance</div>
                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                        <div class="nk-iv-wg3-sub">
                                            <div class="nk-iv-wg3-amount">
                            ...
                            <div class="account-overview__item" style="margin-right:50px;">
                                <div class="account-overview__content">
                                    <div class="nk-iv-wg3-title">Account Performance <em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Current Month Profit"></em></div>
                                    <div class="nk-iv-wg3-group flex-md-nowrap g-4" style="width:80%">
                            ...
                            <div class="account-overview__item" >
                                <div class="account-overview__content">
                                    <div class="nk-iv-wg3-title">Percentage Return</div>
                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                        <div class="nk-iv-wg3-sub">
                                            <div class="nk-iv-wg3-amount">
                                                <div class="number">{{percentageReturn}}%</div>
                                            </div>
                   ...
                   <div class="card-inner">
                        <ul class="nk-iv-wg3-nav">
                            <li><a href="/personDetails"><em class="icon ni ni-notes-alt" data-toggle="tooltip" data-placement="top" title="My Profile"></em> <span></span></a></li>
                            <li><a href="/dashboard"><em class="icon ni ni-growth" data-toggle="tooltip" data-placement="top" title="Dashboard"></em> <span></span></a></li>
                            <li><a href="/depositWithdraw"><em class="icon ni ni-report-profit" data-toggle="tooltip" data-placement="top" title="Deposit/Withdraw"></em> <span></span></a></li>
                            <li><a href="/messages"><em class="icon ni ni-help" data-toggle="tooltip" data-placement="top" title="Message"></em> <span></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-bordered">
                <div id="schemeDetails" class="nk-iv-scheme-details">
                    <ul class="nk-iv-wg3-list">
                        <li>
                            <div class="sub-text">Account Manager</div>
                            <div class="lead-text">{{accountManager}}</div>
                        </li>
                        <li>
                            <div class="sub-text">Algorithm Type</div>
                    ...
                    <table class="datatable-init table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%">Long/Short</th>
                    ...
                    <div class="nk-refwg-invite card-inner">
                        ...
                        <div class="nk-refwg-url">
                            <div class="form-control-wrap">
                                ...
                                <input type="text" class="form-control copy-text" id="refUrl" value="https://www.cointrader24.io">
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    switch(accountType) {
        case \'14 Day Trial\': commission = \'0%\'; break;
        case \'Apollo\': commission = \'0%\'; break;
        case \'Thor\': commission = \'15%\'; break;
        case \'Odin\': commission = \'15%\'; break;
        case \'Zeus\': commission = \'10%\'; break;
    }
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div class="nk-content" style="padding-top:70px;">
';
...
';
                $buffer .= $indent . '                        <div class="account-overview">
';
                $buffer .= $indent . '                            <div class="account-overview__item" >
';
                $buffer .= $indent . '                                <div class="account-overview__content">
';
                $buffer .= $indent . '                                    <div class="nk-iv-wg3-title">Initial Investment</div>
';
...
';
                $buffer .= $indent . '                                <div class="account-overview__content">
';
                $buffer .= $indent . '                                    <div class="nk-iv-wg3-title">Current Balance</div>
';
                $buffer .= $indent . '                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
';
                $buffer .= $indent . '                                        <div class="nk-iv-wg3-sub">
...
';
                $buffer .= $indent . '                            
';
                $buffer .= $indent . '                            <div class="account-overview__item" style="margin-right:50px;">
';
                $buffer .= $indent . '                                <div class="account-overview__content">
';
                $buffer .= $indent . '                                    <div class="nk-iv-wg3-title">Account Performance <em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Current Month Profit"></em></div>
';
                $buffer .= $indent . '                                    <div class="nk-iv-wg3-group flex-md-nowrap g-4" style="width:80%">
';
...
';
                $buffer .= $indent . '                                <div class="account-overview__content">
';
                $buffer .= $indent . '                                    <div class="nk-iv-wg3-title">Percentage Return</div>
';
                $buffer .= $indent . '                                    <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
';
                $buffer .= $indent . '                                        <div class="nk-iv-wg3-sub">
...
';
                $buffer .= $indent . '                            <li><a href="/personDetails"><em class="icon ni ni-notes-alt" data-toggle="tooltip" data-placement="top" title="My Profile"></em> <span></span></a></li>
';
                $buffer .= $indent . '                            <li><a href="/dashboard"><em class="icon ni ni-growth" data-toggle="tooltip" data-placement="top" title="Dashboard"></em> <span></span></a></li>
';
                $buffer .= $indent . '                            <li><a href="/depositWithdraw"><em class="icon ni ni-report-profit" data-toggle="tooltip" data-placement="top" title="Deposit/Withdraw"></em> <span></span></a></li>
';
                $buffer .= $indent . '                            <li><a href="/messages"><em class="icon ni ni-help" data-toggle="tooltip" data-placement="top" title="Message"></em> <span></span></a></li>
';
                $buffer .= $indent . '                        </ul>
';
                $buffer .= $indent . '                    </div>
...
';
                $buffer .= $indent . '                        <li>
';
                $buffer .= $indent . '                            <div class="sub-text">Account Manager</div>
';
...
';
                $buffer .= $indent . '                        <li>
';
                $buffer .= $indent . '                            <div class="sub-text">Algorithm Type</div>
';
                $buffer .= $indent . '                            <div class="lead-text">';
...
';
                $buffer .= $indent . '                                <th style="width: 20%">Pair</th>
';
                $buffer .= $indent . '                                <th style="width: 20%">Long/Short</th>
';
                $buffer .= $indent . '                                <th style="width: 20%">P/L</th>
';
                $buffer .= $indent . '                                
';
                $buffer .= $indent . '                            </tr>
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->sectionD3958046d31cb828bcf9fd73bbedf2d5($context, $indent, $value);
                $buffer .= $indent . '                        </tbody>
';
                $buffer .= $indent . '                    </table>
';
...
';
                $buffer .= $indent . '                                </div>
';
                $buffer .= $indent . '                                <input type="text" class="form-control copy-text" id="refUrl" value="https://www.cointrader24.io">
';
                $buffer .= $indent . '                            </div>
';
                $buffer .= $indent . '                        </div>
...
';
                $buffer .= $indent . '        case \'14 Day Trial\': commission = \'0%\'; break;
';
                $buffer .= $indent . '        case \'Apollo\': commission = \'0%\'; break;
';
                $buffer .= $indent . '        case \'Thor\': commission = \'15%\'; break;
';
                $buffer .= $indent . '        case \'Odin\': commission = \'15%\'; break;
';
                $buffer .= $indent . '        case \'Zeus\': commission = \'10%\'; break;
';
                $buffer .= $indent . '    }
';
