...
class __MyTemplates_61a0b17bdf8845ac6221eb9fc48dd114 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAbbf38e17a129319d897c1f0f5cd6073($context, $indent, $value);
...
';
    ...
    private function sectionAbbf38e17a129319d897c1f0f5cd6073(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                            <div class="form-control-wrap">
';
                $buffer .= $indent . '                                            <span>sdfsfs</span>
';
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
