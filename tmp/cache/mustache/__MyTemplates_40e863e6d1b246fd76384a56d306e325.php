...
class __MyTemplates_40e863e6d1b246fd76384a56d306e325 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section86c6557e13a014e3e88439e55e1a853f($context, $indent, $value);
...
';
    ...
    private function section86c6557e13a014e3e88439e55e1a853f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                        <div style="width:18%">
';
