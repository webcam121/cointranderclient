...
class __MyTemplates_25601260cf4305fc76041c56cd8232f8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4b699ab533e07b32087c5e8c47236f28($context, $indent, $value);
...
';
    ...
    private function section4b699ab533e07b32087c5e8c47236f28(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                        ...
                        <div class="col-xxl-12 col-sm-12">
                            <div class="card card-preview">
                                <div class="card-inner">
                                    ...
                                    <div class="card-container">sdfsfd</div>
...
';
                $buffer .= $indent . '                                    
';
                $buffer .= $indent . '                                    <div class="card-container">sdfsfd</div>
';
                $buffer .= $indent . '
';
