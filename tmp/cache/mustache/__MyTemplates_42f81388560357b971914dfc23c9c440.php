...
class __MyTemplates_42f81388560357b971914dfc23c9c440 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section80c4a047fa7e11ffe7cac873d1ec0086($context, $indent, $value);
...
';
    ...
    private function section80c4a047fa7e11ffe7cac873d1ec0086(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
