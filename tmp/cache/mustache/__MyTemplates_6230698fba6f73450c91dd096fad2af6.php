...
class __MyTemplates_6230698fba6f73450c91dd096fad2af6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2e4dbcef042b342037c31fa3bff81f98($context, $indent, $value);
...
';
    ...
    private function section4143880887861d3318b686c9616a6cd9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <form method="post" action="/adminTradesByUser" enctype="multipart/form-data" class="row gy-3">
                                       ...
                                       <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" id="accountType" value="{{tokenName}}" name="accountType" class="form-control form-control-lg form-control-outlined" readonly>
...
';
    ...
    private function section2e4dbcef042b342037c31fa3bff81f98(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section4143880887861d3318b686c9616a6cd9($context, $indent, $value);
                $buffer .= $indent . '                        </div>   
';
                $buffer .= $indent . '
';
