...
class __MyTemplates_6e03e0bd8d43cc7e0a2e98f6a399d205 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '                        <div class="form-group">
';
        $buffer .= $indent . '                            <button type="submit" class="btn btn-lg btn-primary btn-block">Login in</button>
';
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '                    </form>
...
';
        $buffer .= $indent . '                        <p>&copy; 2022 CoinTrader24 Group. All Rights Reserved.</p>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
