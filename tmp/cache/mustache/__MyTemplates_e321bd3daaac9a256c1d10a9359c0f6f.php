...
class __MyTemplates_e321bd3daaac9a256c1d10a9359c0f6f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section564f741372a0166443b7f575bda27e86($context, $indent, $value);
...
';
    ...
    private function section564f741372a0166443b7f575bda27e86(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            <div class="nk-content-body">
                <div class="nk-block">
                    <div class="row g-gs">
                        ...
                        <div class="card-box">
                            <div class="col-xxl-2 col-sm-6" style="flex-basis: 25%">
                                <div class="card">
...
';
                $buffer .= $indent . '                            <div class="col-xxl-2 col-sm-6" style="flex-basis: 25%">
';
