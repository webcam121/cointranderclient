...
class __MyTemplates_407940befade1c697370ba8313a6753e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA2331a4d76f9f2ea5198b3dc0db1f926($context, $indent, $value);
...
';
    ...
    private function sectionB27d6a2c685775c3633fac93876c53a8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionD4f21e6b1e48c213d1cdd68353aad18f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionB27d6a2c685775c3633fac93876c53a8($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionA2331a4d76f9f2ea5198b3dc0db1f926(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->sectionD4f21e6b1e48c213d1cdd68353aad18f($context, $indent, $value);
                $buffer .= $indent . '                                        </tbody>
';
                $buffer .= $indent . '                                    </table>
';
