...
class __MyTemplates_f265d8644d09c85331ae1697bd939d3f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE9122f1f0fbe513ace99746773b9f84b($context, $indent, $value);
...
';
    ...
    private function sectionB00def79c572de5ba374dd58c6f60f29(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <select id="tokenType" name="tokenType" class="form-select form-control form-control-lg" data-ui="lg" required>
                                                        <option value="bl">{{token_price}}</option>
                                                    </select>
...
';
    ...
    private function sectionE9122f1f0fbe513ace99746773b9f84b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionB00def79c572de5ba374dd58c6f60f29($context, $indent, $value);
                $buffer .= $indent . '                                    </form>
';
                $buffer .= $indent . '                                </div>
';
