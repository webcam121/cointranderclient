...
class __MyTemplates_f2595db32544a5d5c6caf1714812ce75 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7f2a768fc7c37735f54e7119b0de7b77($context, $indent, $value);
...
';
    ...
    private function section7f2a768fc7c37735f54e7119b0de7b77(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
        ...
        <div class="nk-block-head" style="margin-top: 30px;">
            <div class="nk-block-between-md g-4">
                <div class="nk-block-head-content">
                    <h5 class="nk-block-title">Client Account</h5> Overview</h5>
                </div>
               <div class="nk-block-head-content">
...
';
                $buffer .= $indent . '                    <h5 class="nk-block-title">Client Account</h5> Overview</h5>
';
                $buffer .= $indent . '                </div>
';
                $buffer .= $indent . '               <div class="nk-block-head-content">
