...
class __MyTemplates_dba6abe2fdbd2bf831a178738805192f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC379b2060e7b6532b23281ee51801f0f($context, $indent, $value);
...
';
    ...
    private function sectionC379b2060e7b6532b23281ee51801f0f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
