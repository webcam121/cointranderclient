...
class __MyTemplates_ef42f0fcfe098a5da34d627ef71ab06b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6988a265fe7f7a090208aaa1e66c1e92($context, $indent, $value);
...
';
    ...
    private function section6988a265fe7f7a090208aaa1e66c1e92(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                    ...
                    <div class="nk-block-head nk-block-head-lg">
                        <div class="nk-block-between-md g-4">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title fw-normal">ICO Tokens By All Account && Setting Token Price</h2>
...
';
                $buffer .= $indent . '                                <h2 class="nk-block-title fw-normal">ICO Tokens By All Account && Setting Token Price</h2>
';
