...
class __MyTemplates_a5353c099c6b819905a47eab3103b2db extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFfb5100de68e7b98d7c11359f7d245b5($context, $indent, $value);
...
';
    ...
    private function sectionFfb5100de68e7b98d7c11359f7d245b5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                                <span style="font-size:20px">Amount:</span>
';
