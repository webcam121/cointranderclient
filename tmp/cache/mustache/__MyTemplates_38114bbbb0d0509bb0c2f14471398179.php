...
class __MyTemplates_38114bbbb0d0509bb0c2f14471398179 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section68c866d0e193e5d19686d38a8b187279($context, $indent, $value);
...
';
    ...
    private function section68c866d0e193e5d19686d38a8b187279(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '  max-width: 10%;
';
                $buffer .= $indent . '}
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '.card-token-item {
';
...
';
                $buffer .= $indent . '                                                <span  style="font-size:18px">Amount:</span>
';
