...
class __MyTemplates_30a8155160ab1d156c56d47fe9a35316 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5111925da0f3fddc39d4d9d2c8f0fada($context, $indent, $value);
...
';
    ...
    private function section5111925da0f3fddc39d4d9d2c8f0fada(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                            ...
                            <div class="card card-preview">
                                <div class="card-inner">
                                    ...
                                    <div class="card-content-group mb-2">
                                        ...
                                        <div class="card-content">
                                            <span>Amount:</span> <span>25000BITL</span>
                                        </div>
                                        <div class="card-content">
                                            <span>Amount:</span> <span>25000BITL</span>
                                        </div>
...
';
                $buffer .= $indent . '                                        <div class="card-content">
';
                $buffer .= $indent . '                                            <span>Amount:</span> <span>25000BITL</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <div class="card-content">
