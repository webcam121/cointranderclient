...
class __MyTemplates_3203355eb3c9c53afb639ae856570d9f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4980875476de3299f340fbea933db763($context, $indent, $value);

        return $buffer;
    }

    private function section5d98d7fcfdf9787dcd174392c6a3f7d2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                                        <div class="card-token mt-1">
                                            <div class="card-token__item">
                                                ...
                                                <span style="font-size: 15px;">{{number_format(tokenAmount, 3, \',\', \' \')}}</span>
                                            </div>
                                            <div class="card-token__item">
...
';
                ...
                $value = $this->resolveValue($context->find('number_format(tokenAmount, 3, \',\', \' \')'), $context, $indent);
...
';
    ...
    private function section4980875476de3299f340fbea933db763(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section5d98d7fcfdf9787dcd174392c6a3f7d2($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
