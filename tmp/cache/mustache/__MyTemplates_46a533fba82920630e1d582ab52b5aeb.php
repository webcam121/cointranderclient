...
class __MyTemplates_46a533fba82920630e1d582ab52b5aeb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA662287c1c3a86848b2a7e169ec29eab($context, $indent, $value);
...
';
    ...
    private function section23a07be925608335a1074b0f8c5b1ba5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section2e50b18df8b5061136a21f8cb0f18d66(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                                    <td style="padding:0">
                                                    <img src="{{coinImg}}" style="width:38px;margin-left:10px;" alt="coinImg"/>
                                                    </td>
                                                ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                                                    <td style="padding:0">
';
                $buffer .= $indent . '                                                    <img src="';
                $value = $this->resolveValue($context->find('coinImg'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" style="width:38px;margin-left:10px;" alt="coinImg"/>
';
                $buffer .= $indent . '                                                    </td>
';
                $context->pop();
    ...
    private function sectionCe786f16d52436b5aca8058fcbf19ce7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section23a07be925608335a1074b0f8c5b1ba5($context, $indent, $value);
...
';
                // 'coinImg' section
                $value = $context->find('coinImg');
                $buffer .= $this->section2e50b18df8b5061136a21f8cb0f18d66($context, $indent, $value);
                // 'coinImg' inverted section
                $value = $context->find('coinImg');
                if (empty($value)) {
...
';
    ...
    private function sectionD52c0dc9e4726036a68bd538468372e2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionCe786f16d52436b5aca8058fcbf19ce7($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionA662287c1c3a86848b2a7e169ec29eab(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                ...
                <div class="nk-block">
                    <div class="row g-gs">
                        ...
                        <div class="token-card__item">
                            <div class="card">
                                <div class="nk-ecwg nk-ecwg6" style="padding-bottom: 25px;">
                            ...
                            <div class="card card-preview">
                                <div class="card-inner">
                                    <div class="card-title-group mb-2">
                                        <div class="card-title">
                                            <h6 class="title">Algorithm Activity</h6>
                                        </div>
                        ...
                        <div class="col-xxl-8 col-sm-8">
                            <div class="card card-preview">
                                <div class="card-inner">
                                    <h6 class="title">Trade Overview</h6>
                                    <table class="datatable-init table" style="min-height: 290px;">
                                        <thead>
                                            <tr>
                                                <th style="width: 15%">Trade Ref</th>
                                                <th style="width: 35%">Trade Date</th>
                                                <th style="width: 20%">Trading Pair</th>
                        ...
                        <div class="col-xxl-4 col-sm-4">
                            <div class="card" style="height:628px;">
                                <div class="card-inner">
                                    <div class="card-title-group mb-2">
                                        <div class="card-title">
                                        ...
                                        <div class="nk-ck-sm">
                                            ...
                                            <ul class="nk-ecwg7-legends tradeAllocation" style="margin-top: 20px">
                                                ...
                                                var str_li = \'\';
                                                    ...
                                                    var coinImg = {{{chartTradeAllocation.coinImg}}};
                                                    
                                                    for (var i = 0; i < currency.length; i ++) {
                                                        
                                                        str_li += \'<li><div class="title"><img style="width: 45px;margin-right: 5px;" src="\'+ coinImg[i] +
                                                        \'" alt="coinImg"/><span>\'+ currency[i] +\'</span></div></li>\';
                                                    }
                            ...
                            <div class="nk-refwg-invite card-inner">
                                ...
                                <div class="nk-refwg-url">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="text" class="form-control copy-text" id="refUrl" value="https://cointrader24.io">
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    $(\'.datatable-init thead tr th:nth-Child(1)\').click();
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '@media only screen and (min-width:320px) {
';
                $buffer .= $indent . '  .token-card {
';
                $buffer .= $indent . '    display: flex;
';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  .token-card__item {
';
                $buffer .= $indent . '    width: 100%;
';
                $buffer .= $indent . '  }
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '@media only screen and (min-width:1600px){
';
                $buffer .= $indent . '  .token-card {
';
                $buffer .= $indent . '      display: flex;
...
';
                $buffer .= $indent . '                                        {
';
                $buffer .= $indent . '                                            "proName": "BITSTAMP:XRPUSD",
';
                $buffer .= $indent . '                                            "title": "XRP/USDT"
';
                $buffer .= $indent . '                                        },
';
                $buffer .= $indent . '                                        {
';
                $buffer .= $indent . '                                            "proName": "BITSTAMP:LTCUSD",
';
                $buffer .= $indent . '                                            "title": "LTC/USDT"
';
                $buffer .= $indent . '                                        },
';
                $buffer .= $indent . '                                        {
';
                $buffer .= $indent . '                                            "proName": "BITSTAMP:LINKUSD",
';
                $buffer .= $indent . '                                            "title": "LINK/USDT"
';
                $buffer .= $indent . '                                        },
';
                $buffer .= $indent . '                                        {
...
';
                $buffer .= $indent . '                                            "title": "ETH/USDT"
';
                $buffer .= $indent . '                                        },
';
                $buffer .= $indent . '                                         {
';
                $buffer .= $indent . '                                            "proName": "BINANCE:BNBBUSD",
';
                $buffer .= $indent . '                                            "title": "BNB/USDT"
';
                $buffer .= $indent . '                                        }
';
                $buffer .= $indent . '                                        
...
';
                $buffer .= $indent . '                                <div class="nk-ecwg nk-ecwg6" style="padding-bottom: 25px;">
';
...
';
                $buffer .= $indent . '                                                    <h6>Positive Trades</h6>
';
...
';
                $buffer .= $indent . '                                                <div class="progress-text">
';
                $buffer .= $indent . '                                                    <h6>Negative Trades</h6>
';
                $buffer .= $indent . '                                                    <div class="progress-amount" style="font-size: 15px;">';
...
';
                $buffer .= $indent . '                                        <div class="card-title">
';
                $buffer .= $indent . '                                            <h6 class="title">Algorithm Activity</h6>
';
                $buffer .= $indent . '                                        </div>
';
...
';
                $buffer .= $indent . '                                <div class="card-inner">
';
                $buffer .= $indent . '                                    <h6 class="title">Trade Overview</h6>
';
...
';
                $buffer .= $indent . '                                            <tr>
';
                $buffer .= $indent . '                                                <th style="width: 15%">Trade Ref</th>
';
                $buffer .= $indent . '                                                <th style="width: 35%">Trade Date</th>
';
                $buffer .= $indent . '                                                <th style="width: 20%">Trading Pair</th>
';
...
';
                // 'data' section
                $value = $context->find('data');
                $buffer .= $this->sectionD52c0dc9e4726036a68bd538468372e2($context, $indent, $value);
                $buffer .= $indent . '                                        </tbody>
';
                $buffer .= $indent . '                                    </table>
';
...
';
                $buffer .= $indent . '                            <div class="card" style="height:628px;">
';
                $buffer .= $indent . '                                <div class="card-inner">
';
                $buffer .= $indent . '                                    <div class="card-title-group mb-2">
...
';
                $buffer .= $indent . '                                                }
';
                $buffer .= $indent . '                                                @media(max-width: 500px) {
';
                $buffer .= $indent . '                                                    .nk-ecwg7-legends{
';
                $buffer .= $indent . '                                                        flex-direction: column;
';
...
';
                    ...
                    $buffer .= ';
';
                    $buffer .= $indent . '                                                    var coinImg = ';
                    $value = $this->resolveValue($context->findDot('chartTradeAllocation.coinImg'), $context, $indent);
                    $buffer .= $value;
                    $buffer .= ';
';
                    $buffer .= $indent . '                                                    
...
';
                    $buffer .= $indent . '                                                        
';
                    $buffer .= $indent . '                                                        str_li += \'<li><div class="title"><img style="width: 45px;margin-right: 5px;" src="\'+ coinImg[i] +
';
                    $buffer .= $indent . '                                                        \'" alt="coinImg"/><span>\'+ currency[i] +\'</span></div></li>\';
';
                    $buffer .= $indent . '                                                    }
';
...
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <input type="text" class="form-control copy-text" id="refUrl" value="https://cointrader24.io">
';
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
...
';
                $buffer .= $indent . '    $(\'.datatable-init thead tr th:nth-Child(1)\').click();
';
