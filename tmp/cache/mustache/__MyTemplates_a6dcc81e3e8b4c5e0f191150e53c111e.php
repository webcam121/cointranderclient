...
class __MyTemplates_a6dcc81e3e8b4c5e0f191150e53c111e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section35ccf2c4e5eaa6b03d87f9ba247272a1($context, $indent, $value);

        return $buffer;
    }

    private function section8fb103ff8c25b7982ea25407d129ebba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                                                <span>';
                $value = $this->resolveValue($context->find('www'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '</span>
';
                $buffer .= $indent . '                                            </div>
...
';
    ...
    private function section35ccf2c4e5eaa6b03d87f9ba247272a1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->section8fb103ff8c25b7982ea25407d129ebba($context, $indent, $value);
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                </div>
';
