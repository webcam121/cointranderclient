...
class __MyTemplates_4243822f999f7a544e5a66f581082a4e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section455f9fc62026f8a587a0e75fe826a78c($context, $indent, $value);
...
';
    ...
    private function section455f9fc62026f8a587a0e75fe826a78c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
