...
class __MyTemplates_8c1b44ae08444d343a1d658ab1d3d51d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0ff3e8c0f2ed01f2ed03ceea9c11d2df($context, $indent, $value);
...
';
    ...
    private function section0ff3e8c0f2ed01f2ed03ceea9c11d2df(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-group">
                                                        <input type="text" id="initialInvestment" min="300" placeholder="Minimum Investment is 300" class="form-control form-control-lg" required>
...
';
                $buffer .= $indent . '                                                    <div class="form-control-group">
';
                $buffer .= $indent . '                                                        <input type="text" id="initialInvestment" min="300" placeholder="Minimum Investment is 300" class="form-control form-control-lg" required>
';
