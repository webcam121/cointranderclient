...
class __MyTemplates_c9ecce9ba51243d247bce1e1f8ecdbc4 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4137d56bef3d4cfe9c1a67332a64b44c($context, $indent, $value);
...
';
    ...
    private function section4137d56bef3d4cfe9c1a67332a64b44c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                    ...
                                    <div class="card-content mb-5">
                                        <div class="card-token">
                                            <div class="card-token-item">
                                                <span style="font-size:20px; font-style:bold">Amount:</span>
...
';
                $buffer .= $indent . '                                                <span style="font-size:20px; font-style:bold">Amount:</span>
';
