...
class __MyTemplates_d1083ed87f97ec6a57776d8c4a44c7dc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9612c19cee668b2d6b4e58fa911a7d26($context, $indent, $value);
...
';
    ...
    private function section9612c19cee668b2d6b4e58fa911a7d26(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                      
';
                $buffer .= $indent . '                        <div class="" style="width:22%">
';
