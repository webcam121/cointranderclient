...
class __MyTemplates_a386a44f2368ea8aec65b98e6dc09e7f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDce4857e0011ce1573b38534f53e2194($context, $indent, $value);
...
';
    ...
    private function sectionDce4857e0011ce1573b38534f53e2194(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                        ...
                        <div class="col-xxl-12 col-sm-12">
                            <div class="card card-preview">
                                <div class="card-inner">
                                    ...
                                    <div class="card-content-group mb-2">
                                        <div class="card-content">
                                            <span class="title amount">Amount:</span> <span>25000BITL</span>
                                        </div>
                                        <div class="card-content">
                                            <span>Token price:</span> <span>$0.05</span>
                                        </div>
                                        <div class="card-content">
                                            <span>Current Value:</span> <span>$1250</span>
                                        </div>
                                    </div>
...
';
                $buffer .= $indent . '                                    </div>
';
                $buffer .= $indent . '                                    <div class="card-content-group mb-2">
';
                $buffer .= $indent . '                                        <div class="card-content">
';
                $buffer .= $indent . '                                            <span class="title amount">Amount:</span> <span>25000BITL</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <div class="card-content">
';
                $buffer .= $indent . '                                            <span>Token price:</span> <span>$0.05</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                        <div class="card-content">
';
                $buffer .= $indent . '                                            <span>Current Value:</span> <span>$1250</span>
';
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </div>
