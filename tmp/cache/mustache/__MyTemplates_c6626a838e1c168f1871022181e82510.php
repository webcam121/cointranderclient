...
class __MyTemplates_c6626a838e1c168f1871022181e82510 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3d73f2dee9b29ccbfd702422ffe5197e($context, $indent, $value);
...
';
    ...
    private function section3d73f2dee9b29ccbfd702422ffe5197e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
