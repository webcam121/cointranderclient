...
class __MyTemplates_ed100aa87e056625478d0ccf107b56be extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDaceaa4e0d9f547b4fa363d2e39580ec($context, $indent, $value);
...
';
    ...
    private function sectionDaceaa4e0d9f547b4fa363d2e39580ec(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
