...
class __MyTemplates_71a8a7519cdcdc93c46e89e908f2670e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section90d84ac0b8e252c140fd767e07d645e0($context, $indent, $value);
...
';
    ...
    private function section90d84ac0b8e252c140fd767e07d645e0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="card-content mb-5">
                                        <div class="card-token">
                                            ...
                                            <div class="card-token-item">
                                                <span class="pr-2" style="font-size:18px">Current Value:</span>
...
';
                $buffer .= $indent . '                                            <div class="card-token-item">
';
                $buffer .= $indent . '                                                <span class="pr-2" style="font-size:18px">Current Value:</span>
';
