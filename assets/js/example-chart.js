...
!function (NioApp, $) {
  ...
  var barChartData = {
    labels: ["AUD/USD", "CHF/USD", "EUR/GBP", "ERU/USD", "GBP/USD", "USD/JPY"],
    dataUnit: 'People',
    datasets: [{
      label: "join",
      color: "#b695ff",
      data: [5, 10, 23, 29, 14, 6]
    }]
  };
  ...
  var solidLineChart = {
    labels: ["Dec 01", "Dec 02", "Dec 03", "Dec 04", "Dec 05", "Dec 06", "Dec 07", "Dec 08", "Dec 09", "Dec 10", "Dec 11", "Dec 12"],
    dataUnit: 'BTC',
    lineTension: .4,
    legend: true,
    datasets: [{
      ...
      data: [800, 540, 1050, 1200, 820, 850, 600, 800, 540, 1050, 1200, 820]
    }]
  };
  // var filledLineChart = {
  //   labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
